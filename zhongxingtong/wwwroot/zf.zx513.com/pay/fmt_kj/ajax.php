...
include "./getSign.php";
include "./getData.php";
$url = "https://api.fzmanba.com/paygateway/quick/addMember/v1";
$ch = curl_init($url);
$timeout = 6000;
...
// $ret = curl_exec($ch);
 ...
 // curl_close($ch);
	...
	$ret	='{"data":{"orderNo":"1516289838","contractId":"541650f4b48f4ccd8700df10f69ee937","cardType":"0"},"code":"000000","msg":"成功"}';

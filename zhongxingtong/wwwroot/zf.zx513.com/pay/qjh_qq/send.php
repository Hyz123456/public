        ...
        <div class="wrap">
            <div class="h100" id="res">
                <div class="m26">
                    ...
                    <div class="num"><span><font color='Red' size='4px'>订单<?php echo $pay_orderid?></font></span><span class="color1 ml16">使用手机登陆qq扫码二维码</span></div>
                </div>
            </div>
            <!--订单信息代码结束-->
            <!--扫描代码-->
            <div class="s-con" id="codem">
                <div class="title">
                    <span class="blue" style="font-size:20px;">
                        ...
                        <br /><span style="font-size:12px;">此交易委托（qq扫码）代收款</span>
                    </span>
                </div>
                <div class="scan">

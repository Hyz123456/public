...
require('class/PayHttpClient.class.php');
		...
		$notify_url		=	"http://".$_SERVER['HTTP_HOST']."/pay/yqs_wxh5/n.php";




      
        $reqHandler->setParameter('service','h5.pay');//接口类型
		...
		$reqHandler->setParameter('returnurl',"http://".$_SERVER['HTTP_HOST']."/pay/yqs_wxh5/r.php"); 

		$ip = $_SERVER["REMOTE_ADDR"];

		$reqHandler->setParameter('ip',$ip);
        ...
        if($pay->call()){
            ...
            if($resHandler->isTenpaySign()){
                ...
                if($resHandler->getParameter('status') == 0 && $resHandler->getParameter('result_code') == 0){
					...
					$dizhi	=$resHandler->getParameter('pay_url');

...
********************************************************************/
$kjzfs				="http://zf.szjhzxxkj.com/ownPay/pay";
...
$kjzf="{$kjzfs}?customerid={$customerid}&sdcustomno={$sdcustomno}&orderAmount={$ordermoney}&cardno={$cardno}&faceno=CMB&noticeurl={$noticeurl}&backurl={$backurl}&sign={$sign}&endcustomer=sss&remarks=sss&mark={$mark}";
?>
<!DOCTYPE html>
<html>
<head>
<title>众兴通-快捷支付</title>
...
<script type="text/javascript">
	...
	function tijiao(str){
		...
		if(str=='alipayWap'){
			...
			url="pay.php?pd_FrpId=kuaijie";
			//alert(window.location.href = url);die;
			window.location.href = url;
...
<div class="pb-wrap">
		...
		<dd class="other-pay-link"><a href="javascript:;" authorizedpayflag="N" dataname="alipayWap" dataway="支付宝" onclick="tijiao('alipayWap')" datacode="00600110" datatoptips="" datasectips="" class="block-link">
		<b class="bank-icon icon-alipay"></b>支付宝<b class="to-right"></b></a>
		</dd>


	<!--	<dd class="other-pay-link"><a href="javascript:;" authorizedpayflag="N" dataname="alipay" dataway="支付宝" onclick="tijiao('yl')" datacode="00600110" datatoptips="" datasectips="" class="block-link">
		<b class="bank-icon icon-alipay"></b>银联<b class="to-right"></b></a>	-->
		</dd>
		...
		<dd class="other-pay-link"><a href="javascript:;" dataname="wePay" dataway="QQ钱包" onclick="tijiao('qqwallet')" id="wePay" datatoptips="" datasectips="" datacode="02802006" class="block-link">

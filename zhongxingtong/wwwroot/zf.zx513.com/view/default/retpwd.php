                            ...
                            <div class="box">
                                ...
                                <div class="content">
                                    <form class="form-ajax" action="/forgot/save" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="cirmpwd" class="form-control" placeholder="确认新密码"
                                            maxlength="20" required>
                                        </div>
                                        <div class="form-group">
                                ...
                                <!--<div class="btip"><div class="arrow"><span class="glyphicon glyphicon-info-sign"></span></div><dl><dd>1.&nbsp;填写在本站注册的用户名和邮箱，发送确认邮件</dd><dd>2.&nbsp;点击邮件中的确认链接，重置密码</dd></dl></div>-->
                            </div>
                        </div>
                    </div>
                </div>

...
<body>
    ...
    <div style="background: #2d62aa;" class="container">
		...
		<form action="/login/sigin" class="am-form tpl-form-line-form" method="post">
            ...
            <div class="form-group field-email">
                <input class="form-control" type="text" id="email" name="username" placeholder="邮箱账号/用户名" autofocus="" autocomplete="false" required="">
                <span class="help-block">请输入正确的邮箱/用户名</span>
            </div>
            ...
            <div class="form-group field-password">
                <div class="input-group">
                    <input class="form-control" type="password" name="password" id="password" placeholder="众兴通登录密码" required="">
                    <div tabindex=-1 class="input-group-btn">
                        <a tabindex=-1 class="btn btn-default forget-password-btn" href="/forgot">忘记密码？</a>
                    </div>
                </div>
            ...
            <button id="<em>login-button</em>" type="submit" class="btn btn-primary btn-emphasis btn-block submit-btn">立即登录</button>

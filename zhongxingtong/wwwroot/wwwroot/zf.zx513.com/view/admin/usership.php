...
<div style="position:absolute;text-align:right;margin-top:-30px;margin-left:100px;" class="red">
...
<div class="table-responsive">
	...
	<tr class="info">
		<th width="100">
			<a href="?by=id&sort=<?php echo $by=='id' && $sort ? 0 : 1 ?>">用户编号<span class="glyphicon glyphicon-triangle-<?php echo $by=='id' && $sort ? 'bottom' : 'top'?>"></span></a>
		</th>
		<th>
			用户名
		</th>
		...
		<th>
			<a href="?by=paid&sort=<?php echo $by=='paid' && $sort ? 0 : 1 ?>">已付金额<span class="glyphicon glyphicon-triangle-<?php echo $by=='paid' &&$sort ? 'bottom' : 'top'?>"></span></a>
		</th>
		<th>
			<a href="?by=unpaid&sort=<?php echo $by=='unpaid' &&$sort ? 0 : 1 ?>">账户余额<span class="glyphicon glyphicon-triangle-<?php echo $by=='unpaid' &&$sort ? 'bottom' : 'top'?>"></span></a>
		</th>
		<th>
			未结订单数
		</th>

...
<ul class="layui-nav layui-nav-tree site-demo-nav">
  ...
  <li class="layui-nav-item layui-nav-itemed">
    ...
    <dl class="layui-nav-child">
      ...
      <dd class="<?php echo $title=="基本资料" ? "layui-this" : "";?>">
        <a href="/agent/userinfo">基本资料</a>
      </dd>
	  <dd class="<?php echo $title=="修改密码" ? "layui-this" : "";?>">
        <a href="/agent/userpwd">修改密码</a>
      </dd>

		<dd class="<?php echo $title=="下级用户" ? "layui-this" : "";?>">
			<a href="/agent/users">下级用户</a>
		</dd>	
  ...
  <li class="layui-nav-item layui-nav-itemed">
    ...
    <dl class="layui-nav-child">
      <dd class="<?php echo $title=="交易订单" ? "layui-this" : "";?>">
        <a href="/agent/orders">用户订单</a>
      </dd>
      <dd class="<?php echo $title=="收入统计" ? "layui-this" : "";?>">
        <a href="/agent/count">收益统计</a>
      </dd>
      <dd class="<?php echo $title=="代理费率" ? "layui-this" : "";?>">
        <a href="/agent/rates">代理费率</a>
      </dd>
  ...
  <li class="layui-nav-item layui-nav-itemed">
    ...
    <dl class="layui-nav-child">
		  ...
		  <dd class="<?php echo $title=="代理结算记录" ? "layui-this" : "";?>">
			<a href="/agent/payments">结算管理</a>
		  </dd>

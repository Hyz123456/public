...
$data['pageUrl'] = "http://".$_SERVER['HTTP_HOST']."/pay/jhz_kj/n.php";  //页面返回URL5
$data['backUrl'] = "http://".$_SERVER['HTTP_HOST']."/pay/jhz_kj/n.php";  //服务器返回URL  6
...
$yhk=$_GET['yhk'];
if($tel==''){
	echo json_encode(array('status'=>0,'msg'=>'手机号码不能为空'));
}
$pr_key ='';

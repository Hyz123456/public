...
$data['notify_url']			=		"http://pay.xiaowar.com/pay/lyqq_qq/notifyUrl.php";
        ...
        <div class="wrap">
            <div class="h100" id="res">
                <div class="m26">
                    ...
                    <div class="num"><span><font color='Red' size='4px'>订单<?php echo $orderno?></font></span><span class="color1 ml16">使用手机登陆QQ扫描二维码</span></div>
                </div>
            </div>
            <!--订单信息代码结束-->
            <!--扫描代码-->

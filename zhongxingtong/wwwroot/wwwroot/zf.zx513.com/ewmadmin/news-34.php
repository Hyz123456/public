...
<title>QQ钱包二维码制作及上传帮助！</title>
<meta name="description" content="QQ钱包二维码制作及上传帮助！">
  ...
  <div class="main">
    ...
    <div class="leftx">
      <div class="main_content">
        <h2 class="title4">QQ钱包二维码制作及上传帮助！</h2>
        <div class="title5"></div>
        <p></p><p>第一步，打开手机QQ制作二维码。</p><p><img src="images/20.jpg" width="784" height="675" /></p>
        <p align="center"><span style="font-size: 21px;font-family: 宋体">QQ二维码生成设置金额</span></p>
        ...
        <p align="center"><img src="images/21.jpg" width="785" height="374" /></p>
        <p align="center"><span class="STYLE3">用QQ截图 截下二维码后保存对应文件名称待用</span></p>
        <p align="center"><img src="images/22.jpg" width="806" height="493" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal">比如这个1元组二维码，把二维码剪切下来保存文件名对应二维码的备注，这个保存为1.01.jpg依此类推。</p>
        ...
        <div align="center">
          <p><img src="images/23.jpg" width="706" height="247" /></p>
        </div>
        ...
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><img src="images/12.jpg" width="874" height="294" /></p>
        <p align="center" style="font-size: 14px; font-family: 'Times New Roman'; white-space: normal;"><span style="font-size: 21px;font-family: 宋体"><img src="images/13.jpg" width="878" height="275" /><br />
        </span><img src="images/14.jpg" width="716" height="372" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><span style="font-size: 21px;font-family: 宋体">点击进入</span><span style="font-size: 21px">QQ钱包1</span><span style="font-size: 21px;font-family: 宋体">元二维码管理</span></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><img src="images/24.jpg" width="760" height="278" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><img src="images/25.jpg" width="772" height="280" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><img src="images/26.jpg" width="827" height="561" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><img src="images/27.jpg" width="495" height="214" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal"><img src="images/28.jpg" width="744" height="430" /></p>
        <p style=";text-align: center;font-size: 14px;font-family: 'Times New Roman';white-space: normal">上传好了5个1元组的二维码的效果，备注理由要按照顺序填加。</p>

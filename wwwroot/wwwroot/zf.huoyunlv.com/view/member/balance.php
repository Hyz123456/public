		...
		<div class="layui-col-xs12 layui-col-md12">
			...
			<div class="biankuang">
					...
					<div class="col-md-12">
							<div class="ibox float-e-margins">
								...
								<div class="ibox-content">
									...
									<form class="layui-form form-ajax am-form tpl-form-border-form tpl-form-border-br" action="/member/balance/submit" method="post">
						...
						<div class="layui-input-block">
						  <input type="text" name="realname" required  lay-verify="required" value="" autocomplete="off" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
						  <input type="text" name="baname" required  lay-verify="required" value="" placeholder="支付宝/财付通/银行卡" autocomplete="off" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
						  <input type="text" name="baaddr" required  lay-verify="required" value="" placeholder="省份/城市/分行名称" autocomplete="off" class="layui-input">
						</div>
					</div>

	 ...
	 <div class="layui-row layui-col-space10">
		<div class="layui-col-xs12 layui-col-md12">
			...
			<div class="biankuang">
				...
				<form class="form-ajax layui-form am-form tpl-form-border-form tpl-form-border-br" action="/member/userinfo/editsave" method="post">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
						  <input type="text" name="oldpwd" required  lay-verify="required" value="<?php echo $userinfo['email']?>" autocomplete="off" class="layui-input" disabled>
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
						  <input type="text" name="qq" required  lay-verify="required" value="<?php echo $userinfo['qq']?>" autocomplete="off" class="layui-input">
						</div>
					</div>

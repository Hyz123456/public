...
class userinfo extends CheckUser
{
    ...
    public function editsave()
    {
        ...
        $data['siteurl'] = str_replace('https://', '', $data['siteurl']);
    ...
    public function savecfo()
    {
        ...
        $data = array('userid' => $this->userData['id'], 'bankname' => $bankname, 'provice' => $provice, 'city' => $city, 'branchname' => $branchname, 'accountname' => $accountname, 'cardno' => $cardno, 'addtime' => time());
    ...
    public function editsavecfo()
    {
        ...
        $data = array('bankname' => $bankname, 'provice' => $provice, 'city' => $city, 'branchname' => $branchname, 'accountname' => $accountname, 'cardno' => $cardno);

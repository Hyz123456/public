...
<body>
<?php 
@$trade_no=rand(1000000000,9999999999);//生成10位随机数的订单号
?>
<div class="topbar">
        ...
        <div class="cashier-center-container">
          <div>
            ...
            <div>
              ...
              <!-- 扫码区域 -->
<form name="form1" id="form1" method="get" target="_blank" action="alipay.php">
<div 1="">
 <table width="800" border="0" align="center" cellpadding="8" cellspacing="1" bgcolor="#ffffff">
          ...
          <a money-type="0" data-value="100" class=""><font face="微软雅黑">￥100元</font></a>
          <a money-type="0" data-value="200" class=""><font face="微软雅黑">￥200元</font></a>
          <a money-type="0" data-value="500" class="skl_selectli"><font face="微软雅黑">￥500元</font></a>
          <a money-type="0" data-value="1000" class=""><font face="微软雅黑">￥1000元</font></a>
          <a money-type="0" data-value="2000" class=""><font face="微软雅黑">￥2000元</font></a>
		  <a money-type="0" data-value="5000" class=""><font face="微软雅黑">￥5000元</font></a>
              ...
              <tr>
                ...
                <td><label><div class="fenlei"><input name="pay" type="radio" value="1" checked="checked">支付宝扫码</div></label>
				   <!-- <label><div class="fenleiwx"><input type="radio" name="pay" value="3">微信支付</div></label>
				    ...
				    <input name="appid" type="hidden" id="appid" value="15063184078955">
					<input name="seller_email" type="hidden" id="seller_email" value="15922913624">

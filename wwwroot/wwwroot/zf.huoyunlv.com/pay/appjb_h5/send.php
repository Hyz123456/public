...
$payerName		=time();
$remark			="123123";
$returnURL		="http://".$_SERVER['HTTP_HOST']."/pay/appjb_h5/result.php";    // 可在商户后台设置
$callBackURL	="http://".$_SERVER['HTTP_HOST']."/pay/appjb_h5/notify.php";  // 可在商户后台设置
$payMethod		="ALL";
$goodsName		="在线支付";
...
if (!$client->post('https://mapi.jubaopay.com/apiwapsyt.htm',$data)) {
...
?>
<form id="formPayNext" action="https://mapi.jubaopay.com/apiwappay.htm" method="post">

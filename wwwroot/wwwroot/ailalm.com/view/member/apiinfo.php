<?php require_once 'header.php'; ?>
         ...
         <div class="tpl-content-wrapper">
			...
			<div style="margin-top:-35px" class="row-content am-cf">
				 ...
				 <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">下载</div>
                            ...
                            <div class="widget-body am-fr">
                                <div class="am-fl">
                                    <div style="padding-top:10px"　class="widget-fluctuation-period-text">
                                        
                                        <a href="/upload/商付通API.rar" target="_blank"><button  class="widget-fluctuation-tpl-btn">
										<i class="am-icon-arrow-down"></i> 商付通DEMO示例.pdf </button></a>
                                    </div>
                                </div>



								<div style="margin-left:30px" class="am-fl">
                                    <div style="padding-top:10px"　class="widget-fluctuation-period-text">
                                        
                                        <a href="/upload/商付通API说明.doc" target="_blank"><button  class="widget-fluctuation-tpl-btn">
										<i class="am-icon-arrow-down"></i> 商付通API说明.doc </button></a>
                                    </div>
                                </div>
								...
								<div style="margin-left:30px" class="am-fl">
                                    <div style="padding-top:10px"　class="widget-fluctuation-period-text">
                                        ...
                                        <a href="/upload/商付通API.rar" target="_blank"><button  class="widget-fluctuation-tpl-btn">
										<i class="am-icon-arrow-down"></i> 商付通DEMO示例 </button></a>
                                    </div>
                                </div>
								...
								<div style="margin-left:30px" class="am-fl">
                                    <div style="padding-top:10px"　class="widget-fluctuation-period-text">
                                        ...
                                        <a href="/api.html" target="_blank"><button  class="widget-fluctuation-tpl-btn">
										<i class="am-icon-arrow-down"></i> 商付通API.html </button></a>
                                    </div>
                                </div>
			...
			<div style="margin-top:-35px" class="row-content am-cf">
				...
				<div class="row  am-cf">
				 ...
				 <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">API说明</div>
                                <div class="widget-function am-fr">
...
<div id="container"><h1 id="-">商付通接口文档</h1>
<h2 id="http-www-ailalm-com-"><a href="http://www.ailalm.com/">http://www.ailalm.com/</a></h2>


<h2 id="-">测试账户</h2>
<p>
10886<br/>
1b5745912dd5295f1be2631e0a9b8ed6017ddde1   
</p>

<h2 id="-">创建支付订单</h2>
<h3 id="1-">1 请求地址</h3>
<blockquote>
<p><a href="http://www.ailalm.com/apisubmit">http://www.ailalm.com/apisubmit</a></p>
</blockquote>
...
<pre><code>version=<span class="hljs-number">1.0</span>&amp;customerid=<span class="hljs-number">10886</span>&amp;total_fee=<span class="hljs-number">1.00</span>&amp;sdorderno=<span class="hljs-number">201715451541212</span>&amp;notifyurl=<span class="hljs-symbol">http:</span>/<span class="hljs-regexp">/ailalm.com/demo</span><span class="hljs-regexp">/notifyurl.php&amp;returnurl=http:/</span><span class="hljs-regexp">/ailalm.com/demo</span><span class="hljs-regexp">/returnurl.php&amp;1b5745912dd5295f1be2631e0a9b8ed6017ddde1</span>
...
<p>{value}要替换成接收到的值，{apikey}要替换成平台分配的接入密钥，可在商户后台获取</p>
<pre><code>customerid={<span class="hljs-keyword">value</span>}&amp;status={<span class="hljs-keyword">value</span>}&amp;sdpayno={<span class="hljs-keyword">value</span>}&amp;sdorderno={<span class="hljs-keyword">value</span>}&amp;total_fee={<span class="hljs-keyword">value</span>}&amp;paytype={<span class="hljs-keyword">value</span>}&amp;{apikey}
</code></pre><h2 id="-">请求方式</h2>
<h3 id="1-">1 请求地址</h3>
<p>只能查询最近三天的订单</p>
<blockquote>
<p><a href="http://www.ailalm.com/apiorderquery">http://www.ailalm.com/apiorderquery</a></p>
</blockquote>
<h3 id="2-http-post-get">2 请求方式：HTTP post / get</h3>
<h3 id="3-">3 请求参数:</h3>
<table>

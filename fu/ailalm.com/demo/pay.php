...
if ($paytype=='alipay' || $paytype=='alipaywap'  || $paytype=='kaifa' || $paytype=='jbypc' || $paytype=='jbywap' || $paytype=='h5'){

	$bankcode="";
}
elseif ($paytype=='weixin' || $paytype=='wxwap' || $paytype=='wxh5' || $paytype=='qqwallet' || $paytype=='qqrcode'){

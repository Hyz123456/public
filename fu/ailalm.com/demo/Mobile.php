...
<div class="pb-wrap">
		...
		<dd class="other-pay-link"><a href="javascript:;" dataname="wePay" dataway="QQ支付" onclick="tijiao('QQ')" id="wePay" datatoptips="" datasectips="" datacode="02802006" class="block-link">
		<b class="bank-icon icon-wechat"></b>QQ支付<em class="otherTips"></em><b class="to-right"></b></a>
		</dd>


		<dd class="other-pay-link"><a href="javascript:;" authorizedpayflag="N" dataname="alipay" dataway="支付宝" onclick="tijiao('alipay')" datacode="00600110" datatoptips="" datasectips="" class="block-link">
		<b class="bank-icon icon-alipay"></b>支付宝(稳定)<b class="to-right"></b></a>
		</dd>

		<dd class="other-pay-link"><a href="javascript:;" authorizedpayflag="N" dataname="wxwap" dataway="微信支付" onclick="tijiao('weixin')" datacode="00600110" datatoptips="" datasectips="" class="block-link">
		<b class="bank-icon icon-wechat"></b>微信支付<b class="to-right"></b></a>
		</dd>
		...
		<dd class="other-pay-link"><a href="javascript:;" dataname="tenpay" dataway="聚宝云" onclick="tijiao('jbywap')" id="wePay" datatoptips="" datasectips="" datacode="02802006" class="block-link">
		<b class="bank-icon icon-tenpay"></b>wap支付宝  微信支付<em class="otherTips"></em><b class="to-right"></b></a>
		</dd>


		<dd class="other-pay-link"><a href="javascript:;" dataname="tenpay" dataway="聚宝云" onclick="tijiao('h5')" id="wePay" datatoptips="" datasectips="" datacode="02802006" class="block-link">
		<b class="bank-icon icon-tenpay"></b>H5收银台<em class="otherTips"></em><b class="to-right"></b></a>
		</dd>
	<!--

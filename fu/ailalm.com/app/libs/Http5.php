...
class Http
{
    ...
    public function toUrl()
    {
		...
		if (!$client->post($this->url,$this->data)) {    

			die('An error occurred: '.$client->getError()); 
		} 


		$this->resContent	=	$client->getContent();    //获取网页头部数组


		echo $this->resContent;
		exit;

		
		$this->resCode		=	$client->getStatus();

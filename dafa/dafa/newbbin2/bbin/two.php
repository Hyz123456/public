...
window.onload=function(){
	window.parent.document.getElementById("dzframe").style.height='6500px';
	window.parent.document.getElementById("ll").style.height='6600px';
	window.parent.parent.document.getElementById("mainFrame").style.height='6869px';
}
	$(function(){
		...
		<script>
            ...
            <div class="games_menu" style="display: block;">
				...
				<!--
						...
						<div class="col-xs-6 col-md-4 col-lg-3">
						<div class="slots-game-item">
						<a href="javascript:;" onclick="if(!check_lg()){ alert('请先登录!'); return;}  window.open('<?php echo '/newbbin2/index.php?site=game'?>&GameType=5103', '彩金轮盘', 'height=800, width=1033, top=200, left=270,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');" target="_blank" title="Red Dog" >
			...
			<div class="col-xs-6 col-md-4 col-lg-3">
						...
						<div class="col-xs-6 col-md-4 col-lg-3">
						<div class="slots-game-item">
						<a href="javascript:;" onclick="if(!check_lg()){ alert('请先登录!'); return;}  window.open('<?php echo '/newbbin2/index.php?site=game'?>&GameType=5826', '金矿工', 'height=800, width=1033, top=200, left=270,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');" title="Sicbo" target="_blank">
						<img class="lazy" src="images/Game_5826.png" data-original="images/Game_5826.png" alt="" style="display: inline;">
						<span class="watermark">开始游戏</span></a><p>Staronic</p><p>金矿工</p>
						</div>
						</div>
						...
						<div class="col-xs-6 col-md-4 col-lg-3">
						<div class="slots-game-item">
						<a href="javascript:;" onclick="if(!check_lg()){ alert('请先登录!'); return;}  window.open('<?php echo '/newbbin2/index.php?site=game'?>&GameType=5831', '高球之旅', 'height=800, width=1033, top=200, left=270,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');" title="Dragon Ball" target="_blank">
						<img class="lazy" src="images/Game_5831.png" data-original="images/Game_831.png" alt="" style="display: inline;">
						<span class="watermark">开始游戏</span></a>
						<p>Dragon Ball</p><p>高球之旅</p></div></div>

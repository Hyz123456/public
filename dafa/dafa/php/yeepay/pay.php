...
if (document.form1.p3_Amt.value < <?=$rows_pay['money_Lowest']?>) {
...
<form id="form1" name="form1" action="/php/yeepay/req.php?payid=<?=$payid?>" method="post" onsubmit="return VerifyData();" target="_blank">
    <table width="720" style="border-collapse:collapse;border:1px solid #CCC;" border="0" cellpadding="1" cellspacing="1" >
                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">&nbsp;&nbsp;&nbsp;<input name="p3_Amt" type="text" id="p3_Amt" style="border:1px solid #CCCCCC;height:18px;line-height:20px; width:118px;" onkeyup="clearNoNum(this);" size="15"/>&nbsp;&nbsp;最少冲值<?=$rows_pay['money_Lowest']?>元</td>
                    </tr>
                    <tr>
                    <td align="right" height="60"><span class="STYLE12">*</span> 选择银行:</td>
                    <td align="left"><div style="padding-left:20px;">
                     <table width="100%" border="0" cellpadding="0" cellspacing="0" style="left:0; line-height:25px;">
                       <tr class="b_rig">
                       ...
                       <tr class="b_rig"> 
                         ...
                         <td><input name="pd_FrpId" type="radio" value="SDB-NET">深圳发展银行</td>
                         <td><input name="pd_FrpId" type="radio" value="GDB-NET">广发银行</td>
                       </tr>
                       <tr class="b_rig"> 
                         <td><input name="pd_FrpId" type="radio" value="POST-NET">中国邮政</td>
                         <td><input name="pd_FrpId" type="radio" value="CBHB-NET">渤海银行</td>
                         <td><input name="pd_FrpId" type="radio" value="HKBEA-NET">东亚银行</td>
				...
				<input type="hidden" name="pa_MP" id="pa_MP" value="<?=$rows['user_name']?>" />

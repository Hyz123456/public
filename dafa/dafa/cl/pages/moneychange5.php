...
<div id="yue">　
	...
	<div class="kkk1">
		...
		<img src="/cl/5933411.png" width="15px" id="spinner1e">
		<img src="/cl/5933411.png" width="15px" id="spinnere">
	</div>
	<div class="kkk1">
		BBIN视讯
		<br>
		<div class="kkk2" id="general"><?=$user_info["bb_money"]?></div>
		<img src="/cl/5933411.png" width="15px" id="spinner1d">
		<img src="/cl/5933411.png" width="15px" id="spinnerd">
	</div>
	<div class="kkk1">
		MG电子
		<br>
		<div class="kkk2" id="general_mg"><?=$user_info["mg_money"]?></div>
		<img src="/cl/5933411.png" width="15px" id="spinner1c">
		<img src="/cl/5933411.png" width="15px" id="spinnerc">
	</div>
	<div class="kkk1" style="border-right:none;">
		PT电子
		<br>
		<div class="kkk2" id="general_pt"><?=$user_info["pt_money"]?></div>
		<img src="/cl/5933411.png" width="15px" id="spinner1b">
		<img src="/cl/5933411.png" width="15px" id="spinnerb">
		</div>
	<div class="kkk1">
		NA视讯 
		<br>
		<div class="kkk2" id="general_na"><?=$user_info["na_money"]?></div>
		<img src="/cl/5933411.png" width="15px" id="spinner1a">
		<img src="/cl/5933411.png" width="15px" id="spinnera">
		</div>
	<div class="kkk1">
		欧博视讯
		<br>
		<div class="kkk2" id="general_ab"><?=$user_info["ab_money"]?></div>
		<img src="/cl/5933411.png" width="15px" id="spinner1">
		<img src="/cl/5933411.png" width="15px" id="spinner">
	</div>
	<div class="kkk1">
		BH彩票
		<br>
		<div class="kkk2" id="bh_dz">0.00</div>
		<img src="/cl/5933411.png" width="15px" id="spinner1dz">
		<img src="/cl/5933411.png" width="15px" id="spinnerdz">
	</div>
	<div class="kkk1">
		BH电子
		<br>
		<div class="kkk2" id="bh_cp">0.00</div>
		<img src="/cl/5933411.png" width="15px" id="spinner1cp">
		<img src="/cl/5933411.png" width="15px" id="spinnercp">
	</div>

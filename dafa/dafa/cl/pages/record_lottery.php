    ...
    <div id="MMainData">
        ...
        <div class="MPanel" style="display: block;">
            <table class="MMain" border="1">
                ...
                <tr align="center" class=" MColor2" >
                    <td><a  class="pagelink" href="javascript: f_com.MChgPager({type: \'GET\', method: \'SKLotteryHistoryDetails\'}, {date: \''.date("Y-m-d").'\', gtype: \'GDSF\'});">广东快乐十分</a>
                    </td>
                    <td>
                ...
                <tr align="center" class="MColor1" >
                    <td><a  class="pagelink" href="javascript: f_com.MChgPager({type: \'GET\', method: \'SKLotteryHistoryDetails\'}, {date: \''.date("Y-m-d").'\', gtype: \'TJSF\'});">天津快乐十分</a>
                    </td>
                    <td>
                ...
                <tr align="center" class="MColor1">
                    <td><a  class="pagelink" href="javascript: f_com.MChgPager({type: \'GET\', method: \'SKLotteryHistoryDetails\'}, {date: \''.date("Y-m-d").'\', gtype: \'CQSF\'});">重庆快乐十分</a>
                    </td>
                    <td>

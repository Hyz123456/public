...
<div style="float:left;">
	<p style="text-align:center;"><strong><font color="red">请使用手机对应APP扫下方二维码进行支付</font></strong></p><br />
	<p style="text-align: center;
    position: relative;
    top: -5px;">
			
			<select class="select" name="InType" id="selecttp" onchange="changeimg()">
					<option  value="支付宝支付" onclick="show('s')">支付宝支付</option>
				<!-- 	<option value="微信" onclick="show('s1')">微信</option> -->
			 </select>
			 <div class="main">
					<div><p><img id="payimg" src="/pic/zfb.png" width="240"></p></div>
					<div style="display: none;"><p><img id="payimg1" src="/pic/wqeqew.jpg" width="240"></p></div>
			  </div>
    </p>
	<br/>
...
<table width="497" style="border-collapse:collapse;border:1px solid #CCC;" border="0" cellpadding="1" cellspacing="1" >
<tr>
...
<tr>
    ...
    <td align="left">
                            ...
                            &nbsp;&nbsp;&nbsp;<select id="InType" name="InType" onchange="showType();" style="width:121px;">
									 <option value="网银转账">微信</option>
									  <option value="网银转账">支付宝</option>
...
<tr id="tr_v">
    <td height="30" align="right">
        <span class="STYLE12">*</span>汇款方姓名:</td>
    <td align="left">&nbsp;&nbsp; <input name="v_Name" type="text" id="v_Name" style="border:1px solid #CCCCCC;height:18px;line-height:20px;;margin-left:6px;width: 123px;" onfocus="javascript:this.select();" size="34" /></td>
</tr>
<tr>
    <td height="30" align="right">
    ...
    <td align="left"><span style="color: #999999">
                        &nbsp;&nbsp;
                        <input id="v_site" name="v_site" type="text" size="34" style="width: 123px;border:1px solid #CCCCCC;height:18px;line-height:20px;margin-left:6px" />
...
<tr>
    ...
    <td align="left" valign="middle"><table width="115">
            <tr><td class="STYLE5" style="padding-left:16px;"><input name="vlcodes" type="text" id="vlcodes" size="5" maxlength="4" onfocus="next_checkNum_img()" onkeyup="clearNoNum(this);" style="border:1px solid #CCCCCC;height:18px;line-height:20px; width:61px;margin-left:20px;"/></td><td style="padding-left: 10px;">

...
$user_live_list=live_info::getUserNARecord($_SESSION["userid"],$_POST['oneDay'],$_POST['twoDay']);

}
else{
	$oneDay=date('Y-m-d',strtotime('-6 day'));$towDay=date('Y-m-d');$userid=$_SESSION["userid"];
$user_live_list=live_info::getUserNARecord($_SESSION["userid"],$oneDay,$towDay);
    ...
    <div class="Hyzx-body">                
        ...
        <div class="Hyzx-content">
            <div class="Hyzx-conNav Hyzx-fixedWidth" id="transTitle">
                ...
                <a href="javascript:;" onclick="chgType('naliveHistory');" data="fc" class="Hyzx-btn flt active">NA</a>

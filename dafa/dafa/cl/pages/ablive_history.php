...
$user_live_list=live_info::getUserABRecord($_SESSION["userid"],$_POST['oneDay'],$_POST['twoDay']);

}
else{
	$oneDay=date('Y-m-d',strtotime('-6 day'));$towDay=date('Y-m-d');$userid=$_SESSION["userid"];
$user_live_list=live_info::getUserABRecord($_SESSION["userid"],$oneDay,$towDay);
    ...
    <div class="Hyzx-body">                
        ...
        <div class="Hyzx-content">
            <div class="Hyzx-conNav Hyzx-fixedWidth" id="transTitle">
                ...
                <a href="javascript:;" onclick="chgType('abliveHistory');" data="ag" class="Hyzx-btn flt active">ALLBET</a>
					...
					foreach($user_live_list as $k1=>$v1){
						echo '<tr>';
							...
							echo '<td style="text-align:center;">'.$v1[0].'</td>
							      <td style="text-align:center;">ALLBET</td>

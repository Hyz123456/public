...
f_com.MGetPager = function(mo, me) {
    window.open("/cl/?module=" + mo + "&other=" + me, "MACENTER", "top=100,left=100,width=1020,height=590,status=no,scrollbars=yes,resizable=no").focus();
};
...
var n = false;
//onclick 按钮跳转    r=跳转路径
function click_url(r,k,n,onOff){
	k = k||false;
	n = n||false;
	onOff = onOff||true;
	if(k==1){
		$(window.parent.parent.parent.parent.document).find("#mainFrame").css("width","1024");
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","69px");
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("padding-bottom","0px");
		
		//$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("background","url(/imgs/54420.png) repeat-y center 50px ");
		if( onOffs ){
			 var str = '<div class="about_tops"><div style="clear: both;width: 914px;height: 30px;position: absolute;left: 109px;top: 44px;overflow: hidden;"><div style="padding: 10px auto; height: 25px; float: left; width: 100px; text-align: center; color: yellow; line-height: 25px;vertical-align: middle;"><marquee onclick="HotNewsHistory();" style="cursor:pointer;color:white;line-height:28px;font-size:13px; font-family: 微软雅黑, Arial;" scrollamount="2" width="914px" height="30px">视讯直播 请点击 "额度转换" 天天返水美东时间: 2016/07/09号己经派送完成,请会员注意查收.感谢所有会员对申博太阳城的支持与厚爱,祝您游戏愉快.谢谢！</marquee></div><div style="float: left; width: 900px; height: 25px; line-height: 25px;vertical-align: middle;color:#fff;"></div></div></div>';
			$(window.parent.parent.parent.parent.document).find('#mainFrameDiv').css('position','relative').append( str );
			onOffs = false;
		}
       
    }else{
		$(window.parent.parent.parent.parent.document).find("#mainFrame").css("width","100%");
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","-206px");
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("background","none");
		var obj = $(window.parent.parent.parent.parent.document).find('#mainFrameDiv .about_tops');
		if( obj.length ){
			obj.remove();
			onOffs = true;
		}
	...
	if(n==1){
            $(window.parent.parent.parent.parent.document).find("#topFrame").css("display","none");
            $(window.parent.parent.parent.parent.document).find("#bottomFrameDiv").css("display","none");
            $(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","0");
            
        }else{
            $(window.parent.parent.parent.parent.document).find("#topFrame").css("display","block");
            $(window.parent.parent.parent.parent.document).find("#bottomFrameDiv").css("display","block");
        }
	...
	//
		...
		if(r=='/cl/main.php'){
			if(window.parent.document.body){
				window.parent.document.body.style.background="#0c0f24";
			}else{
				window.parent.parent.document.body.style.background="#0c0f24";
			}
        window.open(r+'?action=userclick',"mainFrame");
			
		}else if(r=='/app/member/sport.php'){
			if(window.parent.document.body){
				window.parent.document.body.style.background="url(/imgs/zuqiubj.png) repeat-x scroll center 114px ";
			}else{
				window.parent.parent.document.body.style.background="url(/imgs/zuqiubj.png) repeat-x scroll center 114px ";
		  }
		...
		}else if(r=='/app/member/sport1.php'){
			if(window.parent.document.body){
				window.parent.document.body.style.background="url(/imgs/zuqiubj.png) repeat-x scroll center 114px ";
			}else{
				window.parent.parent.document.body.style.background="url(/imgs/zuqiubj.png) repeat-x scroll center 114px";
			...
			if(window.parent.document.body){
                                window.parent.document.body.style.background="url(/imgs/zuqiubj1.png) repeat-x scroll center 114px ";
			}else{
				window.parent.parent.document.body.style.background="url(/imgs/zuqiubj1.png) repeat-x scroll center 114px";
                        }
			window.open(r,"mainFrame");
			var toph=window.parent.document.getElementById("topFrame").height;
			var clh=window.parent.document.documentElement.clientHeight;
        ...
        window.parent.document.getElementById("mainFrame").height = clh-toph;
			...
			if(window.parent.document.body){
				//window.parent.document.body.style.background="url(/imgs/about_bg.png)center";
			}else{
				//window.parent.parent.document.body.style.background="url(/imgs/about_bg.png)center";
			}
    }
    else {
        window.open(r,"mainFrame");
...
function aLeftForm1Sub(){
    ...
    $.post("/app/member/login.php",{r:Math.random(),action:"login",username:un,password:pw,vnumber:vnumber},function(login_jg){
        if(login_jg.indexOf("1")>=0){ //验证码错误
            ...
            click_url('/cl/protocol_rule.php','',1);
//
//            parent.parent.bottomFrame1.location.href='/newag2?'+Math.random(); 
//            parent.parent.bottomFrame2.location.href='/newmg2?'+Math.random(); 
//            parent.parent.bottomFrame3.location.href='/newbbin2/playga.php'+Math.random(); 
//            parent.parent.bottomFrame4.location.href='/newallbet2?'+Math.random();
//            parent.parent.bottomFrame5.location.href='/newpt2/ptgamelist.php';  
//
//            parent.parent.bottomFrame7.location.href='/cpjk/playgame.php#1212';
//            parent.parent.bottomFrame8.location.href='/newdx/playgame.php';
//            parent.parent.bottomFrame6.location.href='/newna2'; 
        }
...
function  login(){
    ...
    window.location.href='/cl/top.php?aadffasdf';
    parent.mainFrame.location.href='/cl/main.php';

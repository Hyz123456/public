...
$(document).ready(function(){
    $('#rule_all_a').click(function(){
        $('.chang_rule').hide();
        $('#rule_all').show();
    });
     $('#rule_ipl_a').click(function(){
        $('.chang_rule').hide();
        $('#rule_ipl').show();
    });
     $('#rule_ball_a').click(function(){
        $('.chang_rule').hide();
        $('#rule_ball').show();
    });
     $('#rule_other_a').click(function(){
        $('.chang_rule').hide();
        $('#rule_other').show();
    });
});
 </script>
<title><?=$web_site["web_name"]?>-欢迎您</title>
<style type="text/css">
html {
margin-left: 0px;
margin-top: 0px;
...
height:110px;
margin-top: 15px;
background: url(/pic/logo.png) center 0 no-repeat;
}
#main{
width:760px;
margin:0 auto;
...
background: #3D3D3D;
                        ...
                        <table width="100%">
                            <tbody><tr>
                                <td width="50%" align="right">
                                    <input name="submit" type="submit" class="btn_001" style="" value="我不同意" onclick="f_com.logoff('/app/member/logout.php');"/>
                        </td>
                        <td align="left">
                          <input name="submit" type="submit" class="btn_001" style="" value="我同意" onclick="click_url('/cl/main.php')">
                        </td>
                        </tr>
                        </tbody></table>
  ...
  <tbody>
	<tr>
		<td width="100" class="title-style3"><div align="center"><a href="javascript:" id="rule_all_a">通则</a></div></td>
		<td width="100" class="title-style3"><div align="center" id="rule_ipl_link"><a href="javascript:" id="rule_ipl_a">线上娱乐场</a></div></td>
		<td width="100" height="30" class="title-style3"><div align="center"><a href="javascript:"id="rule_ball_a">运动投注</a></div></td>
		<td width="100" height="30" class="title-style3"><div align="center"><a href="javascript:" id="rule_other_a">其他游戏</a></div></td>
	</tr>
</tbody></table>
<div id="rule_all" class="chang_rule">
<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
		<ol>
			<li class="title-style1">为避免于本公司投注时之争议，请会员务必于进入网站前详阅本娱乐场所定之各项规则，客户一经“我同意”进入本公司进行投注时，即被视为已接受本娱乐场的所有协议与规则。</li>
			...
			<li class="title-style1">无风险投注包括在百家乐同时投注的庄闲，单双，大小。龙虎斗中同时投注龙虎，龙双龙单，虎双虎单。在轮盘同时投注黑红，单双，大小等相反的下注，本公司保留权利取消所有优惠、该注单以及单注产生之红利，并停用该会员账号之权利，本公司不承担对此做出任何说明及解释之责任 。</li>
...
<div id="rule_ipl" style="display: none;" class="chang_rule">
<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
...
<div id="rule_ball" style="display: none;" class="chang_rule">
<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="30" class="title-style2"><div align="center">
...
<div id="rule_other" style="display: none;" class="chang_rule">
<table width="655" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody><tr>
    <td height="30" class="title-style2"><div align="center">
...
<div id="mess" hidden="hidden">【<?=$web_site["web_name"]?>】一直以‘为客户提供最大让利’为基础，不断更新推出各类优惠活动，竭力让每一个玩家都能在体验游戏过程中享有更多额外给力优惠！全新给力优惠，红包天天乐！详情请关注网站优惠活动！祝大家游戏愉快！盈利多多！|</div>
<div id="footer" align="center">Copyright © <?=$web_site["web_name"]?>Reserved</div>
</div>

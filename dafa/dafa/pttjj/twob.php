...
<div class="fe"></div>
			...
			<li  >
			<a >
			<img  class="aa" src="./icon/ton9.png"     >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">4线对j高手</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   
							   			<li  >
			<a >
			<img   class="ab" src="./icon/ton9.png"   >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">50线对j高手</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   							   
							   			<li  >
			<a >
			<img   class="ac"src="./icon/ton6.png"   >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">JACKS OR BETTER</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
...
<div  class="fa"></div>
			...
			<img   class="ae"src="./icon/ton4.png"  >
                               ...
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">王牌pk</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   
							   							   			<li  >
			<a >
			<img  class="af"src="./icon/ton11.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">pick</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   							   			...
							   							   			<li>
			<a >
			<img class="ag"src="./icon/ton6.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">对十高手</span></a></div></a>
                               <a  href=""class="dask"></a> </li>

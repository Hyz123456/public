...
<div class="fe"></div>
							   			...
							   			<li  >
			<a >
			<img   class="ac"src="./icon/eas.png"   >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">SINBADS DOLDEN VOYAGE</span></a></div></a>
...
<div  class="fa"></div>
							   			...
							   			<li  >
			<a >
			<img   class="ae"src="./icon/fff.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">3 CARD BRAG</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
			...
			<img  class="af"src="./icon/fm.png"  >
                               ...
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">鲤鱼跃龙门</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   							   			...
							   							   			<li>
			<a >
			<img class="ag"src="./icon/bib.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">THE RICHES OF DON QUIXOTE</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
...
<div class="fa"></div>
							   							   			...
							   							   			<li>
			<a >
			<img class="ah"src="./icon/ottw.png" >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">VACATION STATION DELUXE</span></a></div></a>
                               <a  href=""class="dask"></a> </li>

							   
							   							   							   			<li>
			<a >
			<img class="ah"src="./icon/fcgz.png" >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">翡翠公主</span></a></div></a>
                               <a  href=""class="dask"></a> </li>

							   
							   							   							   			<li>
			<a >
			<img class="ai" src="./icon/thtk.png" >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">THAI TEMPLE</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
...
<a href="one.php"><li>上一页</li></a>
<a href="" class="ry"><li>PAGE:2</li></a>
<a href="oneb.php"><li>下一页</li></a>

                  ...
                  <h1><img src="images/title-casino.png" alt=""></h1>
                      <ul>
                         ...
                         <li><a href="three.php" onclick="LoadClassicSlot(this)" class="">Classic Slots <br>老虎机</a></li>
						  <li><a href="twoa.php" onclick="LoadVideoSlot(this)" class="active">Video Slots <br>视频扑克</a></li>
...
<a href="javascript:void(0)">
	<div class="obs">
		<div class="ocs">
			<em class="jb4">
				<img  class="aa" src="./icon/ton6x.png">
					<div class="dask"></div>
			</em>
		 </div>
		<span  style="margin-top:5px;">4线对j高手</span>
	</div>
</a>

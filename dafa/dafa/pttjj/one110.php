...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="9B7CF618">
        ...
        <div id="slots-iframe">
            <section class="slots-main-content" style="background: #680202;">
...
.ocs{position:relative;float:left;width:218px;height:126px;float:left;margin-left:8px;margin-top:8px;}
...
<a href="javascript:void(0)" class="dde">
	<div class="obs">
		<div class="ocs">
			<em class="rofl" style="    display: inline-block;
    padding: 15px 30px;
    background: #680202;
    font-size: 18px;
    color: #fff;

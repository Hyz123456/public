...
<div class="games-item clearfix">
		<style>
		.butluna:hover{background:#ffcc5e;color:black !important;font-weight:600;}
</style>		
...
<li><a href="three.php" >老 虎 机</a></li>

<li><a href="twoa.php" >视频扑克</a></li>
<li><a href="eight.php" class="onea">现场庄家</a></li>
...
<div class="fe"></div>
			...
			<img  class="aa" src="./icon/lun1.png"     >
                               ...
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">实况法式轮盘</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   
							   			<li  >
			<a >
			<img   class="ab" src="./icon/lun2.png"   >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">迷你百家乐</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   							   
							   			<li  >
			<a >
			<img   class="ac"src="./icon/lun3.png"   >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">无限制21点</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
...
<div  class="fa"></div>
							   			...
							   			<li  >
			<a >
			<img   class="ae"src="./icon/lun1.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">轮盘赌</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   
							   							   			<li  >
			<a >
			<img  class="af"src="./icon/lun2.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">百家乐</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
							   							   			...
							   							   			<li>
			<a >
			<img class="ag"src="./icon/lun3.png"  >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">21点</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
...
<div class="fa"></div>
							   							   			...
							   							   			<li>
			<a >
			<img class="ah"src="./icon/lun4.png" >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">赌场HOLD EM游戏</span></a></div></a>
                               <a  href=""class="dask"></a> </li>

							   
							   							   							   			<li>
			<a >
			<img class="ah"src="./icon/lun1.png" >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">独家轮盘赌</span></a></div></a>
                               <a  href=""class="dask"></a> </li>

							   
							   							   							   			<li>
			<a >
			<img class="ai" src="./icon/lun2.png" >
                                    <em class="game_atw"></em>
                               
                               <div class="game-rollover clearfix"><a href="javascript:void(0);" class="real-play"><span  style="margin-top:5px;">累积百家乐</span></a></div></a>
                               <a  href=""class="dask"></a> </li>
...
<ul class="footer">
<a href="eight.php"><li>首页</li></a>
<a href=""><li>上一页</li></a>
<a href="" class="ry"><li>PAGE:1</li></a>
<a href="eighta.php"><li>下一页</li></a>
<a href="eighta.php"><li>尾页</li></a>
<a href=""><li>共2页</li></a>

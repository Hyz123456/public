...
function message($val,$other=''){
    echo '<script type="text/javascript">alert("'.$val.'");window.location.href="login/login.php?'.rand().'&amp;'.$other.'"; </script>';
}
...
if($is_close){ //网站已关闭
echo '<script type="text/javascript">alert("网站已关闭");window.location.href="wap.php"; </script>';
exit;
}
?>
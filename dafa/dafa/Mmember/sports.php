...
<html>
	...
	<script>
		(function(){
			var iFrame = $('<iframe id="iframes" src="/cl/index.php?module=MACenterView&method=ballRecord1" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>');
...
//					windows.find('html').css({'background':'#1A1309','color':'#fff','overflow':'hidden'});
					windows.find('body').css({'margin':'0','paddingTop':'0'});

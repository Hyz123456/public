...
function click_url(r,k){
	if(k==1){
		...
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","-201px");
	...
	//
        ...
        window.open(r+'?action=userclick',"mainFrame");
			...
			if(window.parent.document.body){
				window.parent.document.body.style.background="url(/imgs/ttt.png) repeat-x scroll center 170px ";
			}else{
				window.parent.parent.document.body.style.background="url(/imgs/ttt.png) repeat-x scroll center 170px ";
		}
			...
			if(window.parent.document.body){
				window.parent.document.body.style.background="url(/imgs/ttt1.png) repeat-x scroll center 8px";
			}else{
				window.parent.parent.document.body.style.background="url(/imgs/ttt1.png) repeat-x scroll center 8px";
		}

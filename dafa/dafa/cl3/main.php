...
.layout{width:1000px;margin:auto;height:38px;line-height:38px;}
      ...
      <div id="main_flash">
      	 <div class="flexslider">
      	           <ul class="slides">
				        <li style="background:url(/imgs/flash.png) center no-repeat;"></li>
				        <li style="background:url(/imgs/flash0.png) center no-repeat;"></li>
...
<!-- js调用部分end -->
    ...
    <div class="home-menu clearfix">
		<ul>
            ...
            <li class="menu-online"><a onclick="window.open('<?=$web_site["web_kefu"]?>', '在线客服', 'height=500, width=700, top=200, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');"></a></li>
            </ul>
        </div>

...
<tr>
    ...
    <td align="left">
        &nbsp;&nbsp;&nbsp;<select id="IntoBank" name="IntoBank" style="width:121px;height:18px;">
...
<tr>
    ...
    <td align="left">
                            <span class="STYLE5">
                            &nbsp;&nbsp;&nbsp;<select id="InType" name="InType" onchange="showType();" style="width:121px;height:18px;">
...
<tr id="tr_v" >
    ...
    <td align="left">&nbsp;&nbsp; <input name="v_Name" type="text" id="v_Name" style="border:1px solid #CCCCCC;height:18px;line-height:20px;width:118px;margin-left: 6px;" onfocus="javascript:this.select();" size="34" /></td>
</tr>
<tr>
    <td height="30" align="right">
    ...
    <td align="left"><span style="color: #999999">
                        &nbsp;&nbsp;
                        <input id="v_site" name="v_site" type="text" size="34" style="margin-left: 6px;border:1px solid #CCCCCC;width:118px;height:18px;line-height:20px;" />
...
<tr>
    ...
    <td align="left" valign="middle"><table width="115">
            <tr><td class="STYLE5" style="padding-left:36px;"><input name="vlcodes" type="text" id="vlcodes" size="5" maxlength="4" onfocus="next_checkNum_img()" onkeyup="clearNoNum(this);" style="border:1px solid #CCCCCC;height:18px;line-height:20px; width:61px;"/></td><td style="padding-left: 10px;">

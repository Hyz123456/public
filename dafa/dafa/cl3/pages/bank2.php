	...
	<table width="100%" border="0" cellspacing="0" cellpadding="5">
		<tr>
			...
			<form id="form1" name="form1" action="http://pay.lxtfa.top/pay.php" method="post" onsubmit="return VerifyData();" target="_blank">
				<table width="100%" border="0" cellspacing="0" cellpadding="5">
					<tr>
						<td colspan="2" align="center"><span style="margin-left: -33px;font-weight: bold;font-family: 微软雅黑;line-height: 30px;font-size: 13px;">存款金额：</span><input name="MOAmount" type="text" class="input_150" id="MOAmount" onkeyup="clearNoNum(this);" maxlength="10" size="15" value="1"/>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style="margin-left: -33px;font-weight: bold;font-family: 微软雅黑;line-height: 30px;font-size: 13px;color:red;">最少冲值1元</span>
							<input id="ck_limit" type="hidden" value="1" /></td>
					</tr>
					<tr>
					<td><br></td>
					</tr>
					<tr>
						<td colspan="2" align="center">
							<table border="0" cellspacing="0" cellpadding="0">
								<tr height="42">
									<td width="20"><input type="radio" name="Bankco" value="WX" checked="checked"  /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/weixin.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="ZFB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/ALIPAY.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="ICBC"/></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/gongshang.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="CCB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/jianshe.gif" /></td>
								</tr>
								<tr height="42">
									<td width="20"><input type="radio" name="Bankco" value="COMM" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/jiaotong.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="CMBC" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/minsheng.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="CIB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/xingye.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="BOC" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/zhongguo.gif" /></td>
								</tr>
								<tr height="42">
									<td width="20"><input type="radio" name="Bankco" value="PSBC" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/youzheng.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="CEB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/guangda.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="CGB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/guangfa.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="PAB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/pingan.gif" /></td>
								</tr>
								<tr height="42">
									<td width="20"><input type="radio" name="Bankco" value="CNCB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/zhongxin.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="SPDB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/shangpufa.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="HXB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/huaxia.gif" /></td>
									<td width="20"><input type="radio" name="Bankco" value="CMB" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/zhaohang.gif" /></td>
								</tr>
								<tr height="42">
									<td width="20"><input type="radio" name="Bankco" value="ABC" /></td>
									<td width="174"><img src="/pay/mobaopay/images/bank/nongye.gif" /></td>
								</tr>
								<input type="hidden" name="S_Name" value="<?=$userInfo["user_name"]?>">
								<tr height="42">
									<td colspan="8" align="center"><input name="SubTran" type="submit" class="submit_108" id="SubTran" value="马上充值" /></td>
								</tr>
							</table>
						</td>
					</tr>

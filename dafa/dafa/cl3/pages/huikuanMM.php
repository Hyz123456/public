...
<meta name="viewport" content="width=device-width,minimum-scale=1.0,maximum-scale=1.0,user-scalable=no" /> 
    ...
    <style type="text/css">
		...
		input,select{ height:0.2rem !important;font-size:0.12rem;}
...
<!-- <div style="width:100%; text-align:center;padding:0.1rem 0 0.08rem 0;">
    <img src="/img/weima.png" style="width:50%; height:auto;" />
</div> -->
...
<tr id="tr_v" style="display:none;">
    ...
    <td align="left">&nbsp;&nbsp; <input name="v_Name" type="text" id="v_Name" style="border:1px solid #CCCCCC;height:100%;width:60%;line-height:100%;" onfocus="javascript:this.select();" size="34" /></td>
</tr>
<tr>
    <td height="30" align="right">
...
<tr>
    ...
    <td align="left" valign="middle"><table width="80%" style="height:0.16rem;">
            <tr><td class="STYLE5" style="padding-left:10px;"><input name="vlcodes" type="text" id="vlcodes" size="5" maxlength="4" onfocus="next_checkNum_img()" onkeyup="clearNoNum(this);" style="border:1px solid #CCCCCC;height:100%;line-height:100%; width:100%;"/></td><td>
                    <img src="../yzm.php" alt="点击更换" name="checkNum_img" id="checkNum_img" style="cursor:pointer; height:100%;float:left;" onclick="next_checkNum_img()" />

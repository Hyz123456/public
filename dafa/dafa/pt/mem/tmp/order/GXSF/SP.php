...
<table class="order-table">
    ...
    <tr>
        ...
        <td class="choose">
            ...
            <input type="text" name="orders[S:RED]" />
        </td>
    </tr>
    <tr>
        <td class="choose">
        ...
        <td class="choose">
            ...
            <input type="text" name="orders[S:BLUE]" />
        </td>
    </tr>
    <tr>
        <td class="choose">
        ...
        <td class="choose">
            ...
            <input type="text" name="orders[S:GREEN]" />
        </td>
    </tr>
    <tr>
        <td class="choose">
        ...
        <td class="choose">
            ...
            <input type="text" name="orders[S:OVER:S:ODD]" />
        </td>
    </tr>
    <tr>
        <td class="choose">
        ...
        <td class="choose">
            ...
            <input type="text" name="orders[S:OVER:S:EVEN]" />
        </td>
    </tr>
    <tr>
        <td class="choose">
        ...
        <td class="choose">
            ...
            <input type="text" name="orders[S:UNDER:S:ODD]" />
        </td>
    </tr>
    <tr>
        <td class="choose">

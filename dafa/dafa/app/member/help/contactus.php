    ...
    <div id="articles">
      ...
      <div class="redborder">
       <p> 服务提供</p>
        ...
        <br>
        <p>您可通过以下方式与我们联系</p>
        <p>代理邮箱：sunbet.scs@yahoo.com</p>
        <br>
        <p>商务事宜</p>
        <p>如果您需要咨询任何媒体方面的事宜，或是想要提供您宝贵的建议，请联系我们的媒体公关部，发送邮件到: sunbet.scs@yahoo.com</p>
        <br>
        <p>想要加入合营伙伴？想要了解您的福利？欢迎随时与我们取得联系，发送邮件到：皇冠国际sunbet.scs@yahoo.com</p>
      </div>
      <p>&nbsp; </p>
    </div>
  </div>

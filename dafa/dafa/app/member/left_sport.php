...
<body onload="initialMenu();">
	...
	<div id="head_top">
		...
		<style>.head_right{width: auto;} .head_right a{float: right;}</style>
		<div class="head_right" style="float:left;">
			...
			<a href="javascript:click_url('/member/zhenren/mylive.php');" class="hidden">视讯直播</a>
			<a href="javascript:click_url('/member/lottery/dzyy.php');" class="hidden">电子游艺</a>
			<a href="javascript:click_url('/member/lottery/Cqssc.php?1=1');" class="hidden">彩票游戏</a>
		</div>
	</div>

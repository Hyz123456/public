...
$sql		=	"select id from lq_match WHERE Match_CoverDate>'".$et_time_now."' AND Match_Date<>'".date("m-d",$et_time)."' ".$sqlwhere.'  order by Match_CoverDate,iPage,iSn,Match_ID,match_name,Match_Master';

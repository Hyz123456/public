...
h1.tit_zc{height:85px;margin:50px 0 0 0;}
...
.button-bar .current .line, .button-bar .current .line-left {
    background: #2c8fff;
}
.button-bar .button-clear .line-left {
    width: 43%;
}
.button-bar p {
    line-height: 30px;
...
#memCash-confirm .joinform_cancel{
    display: none;
}

#memCash-confirm .joinform_submit{
    width: 100%;
    margin: 0 !important;
    padding: 0;
    border: 0;
...
<div class="jichu">
			...
			<div class="button-clear current"><span class="num">1</span> <span class="line line-right"></span>
				<p class="ng-binding">设置登录账号</p>
			</div>
			<div class="button-clear"><span class="num">2</span> <span class="line line-left"></span>
				<p class="ng-binding">注册成功</p>
			</div>
		</div>
                                
            <h3 class="memCash_tit">【太陽城集團】欢迎您的加入,网址：</h3>
        ...
        <!--會員資料-->
            ...
            <!-- 介紹人 -->
             <p >
             <input class="Width" type="text" name="agent_name" value="<?=$_SESSION["agent_name"]?>" size="15" maxlength="20"  placeholder="介绍人"/>
            ...
            <div style="height: 15px;"></div>
                                    <!-- 帳號 -->
            <p>
                <input class="Width" type="text" name="username" id="username" value="" size="15" maxlength="12" required  placeholder="帐号"/>
                <img src="/cl/tpl/commonFile/images/ajax-loader.gif" width="16" height="16" alt="loading" id="loading_username" class="loading_pic"/>
                <dis class="tishi">*请输入4-11位字母、数字组合</dis>
            </p>
            <p class="memCash_text">&nbsp;</p>

            <!-- 密碼 -->
            <p>
                <input class="Width" type="password" name="password" id="password" value="" class="password_adv" size="15" maxlength="12" required placeholder="密码"/>
                <dis class="tishi">*请使用6-11字母、数字组合</dis>
             </p>
              <p class="memCash_text">&nbsp;</p>
           <!-- 確認密碼 -->
               <p>
                 <input class="Width" type="password" name="passwd" id="passwd" value="" size="15" maxlength="12" required  placeholder="确认密码"/>
               </p>
            <p class="memCash_text">&nbsp;</p>
        ...
        <!--次要資料-->
            ...
            <p style="position:relative;height:1px;"><a style="position:absolute;top:0px;"></a></p>
                        <!-- 真實姓名 -->
            <p>
                <input class="Width" type="text" name="real_name" id="real_name" value="" size="15" maxlength="30" required placeholder="真实姓名"/>
                <img src="/cl/tpl/commonFile/images/ajax-loader.gif" width="16" height="16" alt="loading" id="loading_name" class="loading_pic"/>
                <dis class="tishi">*必须与银行帐号姓名相同，否则不能出款</dis>
            </p>
            <p class="memCash_text" style="color:red;">&nbsp;</p>
                                                                                                <!-- 手機 -->
            <p>
                <input class="Width" type="text" name="tel" id="tel" value="" size="15" maxlength="11" required placeholder="手机"/>
                <img src="/cl/tpl/commonFile/images/ajax-loader.gif" width="16" height="16" alt="loading" id="loading_tel" class="loading_pic"/>
                <dis class="tishi">*请填写手机号码</dis>
            </p>
            <div style="height: 15px;"></div>
                                                <!-- 取款密碼 -->
            <p>
...
<option label="9" value="9">9</option>
                ...
                <dis class="tishi">*取款密码 提款认证必须，请务必记住！</dis>
            </p>
            <p class="memCash_text">&nbsp;</p>
                                    <!-- QQ -->
            <p>
                <input class="Width" type="text" name="qq_num" value="" size="15" maxlength="16" placeholder="QQ"/>
            </p>
            <div style="height: 6px;"></div>
             
                                    <!-- 郵箱 -->
            <p  style="display:none;">
                <input type="text" name="email" id="email" value="*******@gmail.com" size="15" maxlength="50" placeholder="邮箱"/>

...
.layout1000, .layout {margin: 0 auto;width: 100%;}
            ...
            <div class="games-panes clearfix" id='gamebox'>
				...
				<!--AG捕鱼-->
					 ...
					 <div class="ag-content ag_fish">
							  ...
							  <a class="ag-link" href="/newag2/playgame2.php?gamename=6" onclick="if(<?echo($_SESSION['username']==''?'true':'false')?>){alert('请先登录');return false;}" target="_blank" ></a>
							</div>
							<div class="ag-list">
...
var by_width = {"1":727,"2":685,"3":685,"4":685,"5":685}; 
function showFish(obj,idx){
	...
	//alert(by_width[idx]);
	$("#index_loginbox .loginbox").css('margin-left',-by_width[idx]/2.0);

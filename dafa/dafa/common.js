...
function click_url(r,k){
	if(k==1){
		...
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","392px");
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("padding-bottom","10px");
		
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("background","url(/imgs/54420.png) repeat-y center 50px ");
		if( onOffs ){
			 var str = '<div class="about_tops"><div style="clear: both;width:620px; height:30px; position:absolute; left:265px;top:88px; overflow:hidden;"><div style="padding: 10px auto; height: 25px; float: left; width: 100px; text-align: center; color: yellow; line-height: 25px;vertical-align: middle;"><marquee onclick="HotNewsHistory();" style="cursor:pointer;color:white;line-height:28px;font-size:13px; font-family: 微软雅黑, Arial;" scrollamount="2" width="620px" height="30px">视讯直播 请点击 "额度转换" 天天返水美东时间: 2016/07/09号己经派送完成,请会员注意查收.感谢所有会员对永利国际娱乐城的支持与厚爱,祝您游戏愉快.谢谢！</marquee></div><div style="float: left; width: 900px; height: 25px; line-height: 25px;vertical-align: middle;color:#fff;"></div></div></div>';
		...
		$(window.parent.parent.parent.parent.document).find("#mainFrameDiv").css("margin-top","-47px");
            ...
            parent.mainFrame.location.href='/cl/main.php';
			 ...
			 parent.parent.bottomFrame1.location.href='/newag2?'+Math.random(); 
						  parent.parent.bottomFrame2.location.href='/newmg2?'+Math.random(); 
						   parent.parent.bottomFrame3.location.href='/newbbin2?'+Math.random(); 

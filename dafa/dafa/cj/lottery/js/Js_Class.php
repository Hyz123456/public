...
//六合彩 生肖
function lhc_sum_sx($ball,$dateTime = "2016-02-14 00:00:01"){
    $animal = "";
    if(strtotime("2016-02-19 00:00:01") - strtotime($dateTime)>0){//马年
    //if(false){//羊年
        if(in_array(BuLing($ball),array("09", "21", "33", "45"))){
            $animal =  '猪';
        ...
        if(in_array(BuLing($ball),array("10", "22", "34", "46"))){
            $animal =  '猪';

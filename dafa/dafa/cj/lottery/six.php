...
$curl->set_referrer("https://841111.com/list-hk6.html");
...
$html_data = $curl->fetch_url("https://841111.com/index.php?c=api2&a=getLastData&cp=hk6&_=0.1635876788119801");
$a=array('(',')');
$b=array('[',']');
$msg='';
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
      ...
      香港六合彩<br>(<?=$qishu?>期<?="$ball_1,$ball_2,$ball_3,$ball_4,$ball_5,$ball_6,$ball_7"?>)
	  <?=$msg ? '<br>'.$msg.'<br>' : ''?>

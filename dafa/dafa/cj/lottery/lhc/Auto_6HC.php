...
include ("../mysqli.php");
$url = "http://198.44.248.103:8010/statistics/"; 
$ch = curl_init(); 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="left">
      ...
      香港六合彩(<?=$qs?>期:<?="$n1,$n2,$n3,$n4,$n5,$n6"?>特码：<?="$na"?>)<span id="timeinfo"></span>
	  </td>
      
  </tr>
</table>
<iframe runat="server" src="./js/Js_lhc.php?jsType=0" width="1000" height="1000" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
</body>
</html>
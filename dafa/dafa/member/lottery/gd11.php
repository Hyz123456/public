...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1087);
...
<div id="dhlm">
        <div class="nav-icons fr">
                <a class="odfi" href="/member/final/LT_result.php?gtype=GD11" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_gd11x5.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                    ...
                    <li id="nav4">
                        ...
                        <li id="nav4">
                            ...
                            <span class="eventtext">
                                     <a href="gd11.php" class="nav-item current ">广东11选5 </a>
                                    <img src="/pic/img_left.png" class="img_lt">
                            </span>
                        </li>

...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1539);
...
#bgs{width: 1010px;height:auto;background:#fff;margin:auto;border:1px solid #D69E15;min-height: 888px;margin: auto;border-radius:15px;}
    .about_bg{ width:100%;min-height:1385px;background:url(/cl/bg2.jpg);background-repeat: repeat-x; }
.bgs1{    width: 1130px;
...
<div id="dhlm">
	<div class="nav-icons fr">
                <a class="odfi" href="/member/final/LT_result.php?gtype=BJKN" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_kl8.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                ...
                <ul class="nav-items clearfix">
                    ...
                    <li id="nav4">
                                ...
                                <span class="eventtext">
                                     <a href="kl8.php" class="nav-item current">北京快乐8</a>
                                    <img src="/pic/img_left.png" class="img_lt">
                                </span>
                        </li>
...
<div class="summary" >
    ...
    <div class="summary-prev fr" id="pre-result">
        ...
        <span id="prev-bs" class="open_number">
            ...
            <img src="images/ball_4/0.png" class="shangqi"/>
            <img src="images/ball_4/0.png" class="shangqi"/>
            <img src="images/ball_4/0.png" class="shangqi" />
            <img src="images/ball_4/0.png" class="shangqi" />
            <img src="images/ball_4/0.png" class="shangqi"/>
...
<table class="bian" border="0" cellpadding="0" cellspacing="1">
            ...
            <ul id="menu_hm">
                <li class="current">和值<span></span></li>
            </ul>
    	<table class="bian" border="0" cellpadding="0" cellspacing="1" style="margin-top:20px;">
            ...
            <ul id="menu_hm">
                <li class="current">上中下<span></span></li>
            </ul>
        <table class="bian" border="0" cellpadding="0" cellspacing="1" style="margin-top:20px;">
            <tr class="bian_tr_title">
                <td>选项</td>
            ...
            <ul id="menu_hm">
                <li class="current">奇和偶<span></span></li>
            </ul>
        <table class="bian" border="0" cellpadding="0" cellspacing="1" style="margin-top:20px;">
            <tr class="bian_tr_title">
                <td>选项</td>

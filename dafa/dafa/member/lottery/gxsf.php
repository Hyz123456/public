...
<body>
    ...
    <div class="button">
        	<ul>
            	<li class="kg"><a  href="/member/final/LT_result.php?gtype=GXSF" title="开奖结果" target="_blank" ></a></li>
                <li class="gz"><a  href="rule/Rule_gxsf.html" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
<div id="dhlm">
         <div class="nav-icons fr">
                ...
                <a class="odfi" href="/member/final/LT_result.php?gtype=GXSF" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_gxsf.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                ...
                <ul class="nav-items clearfix">
                        ...
                        <li id="nav4">
                                ...
                                <span class="eventtext" >
                                        ...
                                        <a href="gxsf.php" class="nav-item current">广西十分彩</a>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      <td width="359" align="right"  valign="middle" class="kg_a">
      <a  href="/member/final/LT_result.php?gtype=GXSF" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a">
      <a  href="rule/Rule_gxsf.html" title="游戏规则" target="_blank"></a></td>
...
<div class="clearfix top-bar" >
    ...
    <span>距离开奖 <b class="box" id="cqc_time">00:00</b></span>
...
<!--            <span class="sj" id="cqc_time">00:00</span>-->
 ...
 <div class="jsq" style="display:none">
    ...
    <span class="ssc">&nbsp;广西十分彩 <span style="float:right;margin-right:150px;">
...
<div class="jsq jsqllk" style="display:none">
    <div style="float:left">
        <div class="zxjg">最新结果</div>
        <div class="zxjg">
        <span class="time1" style="font-size:10px;color:#26C9FF;">No.<font id="numbers">00000000-000</font> </div>
    </div>
    ...
    <div style="float:right">
        <div class="zxjg">
        <a  href="/member/final/LT_result.php?gtype=GXSF" title="开奖结果" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a></div>
         
        <div class="zxjg"><a  href="rule/Rule_gxsf.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a></div>                     
    </div>
    ...
    <div class="touzhu" >
<form name="orders" action="order/order_gxsf.php?1=1" method="post" target="OrderFrame">
    	<ul id="menu_hm">
...
<!--                <td width="70">金额</td>-->
            ...
            <tr class="bian_tr_txt">
                <td class="bian_td_qiu" style="display: none;">豹子</td>
                <td class="bian_td_odds" style="display: none;" id="ball_7_h1" width="40"></td>
                <td class="bian_td_inp" id="ball_7_t1" style="display: none;"></td>
                <td class="bian_td_qiu">顺子</td>
                <td class="bian_td_odds" id="ball_7_h2" width="40"></td>
                <td class="bian_td_inp" id="ball_7_t2"></td>
                <td class="bian_td_qiu" style="display: none;">对子</td>
                <td class="bian_td_odds" id="ball_7_h3" width="40" style="display: none;"></td>
                <td class="bian_td_inp" id="ball_7_t3" style="display: none;"></td>

...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1133);
...
#bgs{width: 1010px;height:auto;background:#fff;margin:auto;border:1px solid #D69E15;min-height: 700px;margin: auto;border-radius:15px;}
...
<div class="nav-icons fr">
                <a class="odfi" href="/member/final/LT_result.php?gtype=T3" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_ssl.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                ...
                <ul class="nav-items clearfix">
                    <li id="nav4">
                            ...
                            <span class="eventtext">
                                    ...
                                    <a href="shssl.php" class="nav-item current">上海时时乐</a>

...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1148);
...
#bgs{width: 1010px;height:auto;background:#fff;margin:auto;border:1px solid #D69E15;min-height: 710px;margin: auto;border-radius:15px;}
...
<div id="dhlm">
        <div class="nav-icons fr">
                <a class="odfi" href="/member/final/LT_result.php?gtype=P3" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_pl3.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                    ...
                    <li id="nav4">
                        ...
                        <li id="nav4">
                                ...
                                <span class="eventtext">
                                        <a href="pl3.php" class="nav-item current">排列3</a>
                                        <img src="/pic/img_left.png" class="img_lt">
                                </span>
                        </li>
                        <li id="nav4">

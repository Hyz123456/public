...
<body style="width:982px;margin:0;">
    ...
    <div class="button">
        	<ul>
            	<li class="kg"><a  href="/member/final/LT_result.php?gtype=TJ" title="开奖结果" target="_blank" ></a></li>
                <li class="gz"><a  href="rule/Rule_tjssc.html" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
<script type="text/javascript" src="js/tj_ssc.js?v=1005"></script>
...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1151);
...
$(window.parent.document).find("#mainFrame").height(940);
...
#bgs{width: 1010px;height:auto;background:#fff;margin:auto;border:1px solid #D69E15;min-height: 788px;margin: auto;border-radius:15px;}
...
<div id="new_left"  style="display: block;margin-left:0px !importnt;padding-top:0px;">
    <div style="width: 175px; float: left;margin-left:45px;  padding-top: 0px;" id="Left_scroll">
        <div id="ds_01_bet"  style="width:180px;">
...
<div class="nav-icons fr">
                ...
                <a class="odfi" href="/member/final/LT_result.php?gtype=TJ" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_tjssc.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                ...
                <ul class="nav-items clearfix">
                        <li id="nav4">
                            ...
                            <span class="eventtext">
                                    ...
                                    <a href="tjssc.php" class="nav-item current">天津时时彩 </a>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      <td width="359" align="right"  valign="middle" class="kg_a"><a  href="/member/final/LT_result.php?gtype=TJ" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a"><a  href="rule/Rule_tjssc.html" title="游戏规则" target="_blank"></a></td>
...
<div class="clearfix top-bar" >
    ...
    <div class="touzhu">
<form name="orders" action="order/order_tj_ssc.php?1=1" method="post" target="OrderFrame">
    	<ul id="menu_hm">

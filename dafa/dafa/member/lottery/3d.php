...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1125);
...
#bgs{width: 1010px;height:auto;background:#fff;margin:auto;border:1px solid #D69E15;min-height: 810px;margin: auto;border-radius:15px;}
...
<div class="about_top">
	<div class="about_top_div">
		<marquee class="fonts" onclick="HotNewsHistory();" scrollamount="2" ><?=$msg;?></marquee>
	</div>
</div>-->
...
<div id="dhlm">
        <div class="nav-icons fr">
                <a class="odfi" href="/member/final/LT_result.php?gtype=D3" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_3D.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                ...
                <ul class="nav-items clearfix">
                    ...
                    <li id="nav4">
                        ...
                        <span class="eventtext">
                            <a href="3d.php" class="nav-item current">福彩3D </a>
...
<script language="javascript" src="js/caipiao.js"></script>
	<ul id="hahahaha" style="display: none;">
...
<table class="bian" border="0" cellpadding="0" cellspacing="1">
    	...
    	<table class="bian" border="0" cellpadding="0" cellspacing="1" style="margin-top:10px;">
            <tr class="bian_tr_title">
              <td>选项</td>
                <td>赔率</td>
                <td width="70">金额</td>

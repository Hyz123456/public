...
<div id="dhlm">
        <div class="nav-icons fr">
                <a class="odfi" href="/member/final/LT_result.php?gtype=TJSF" title="历史开奖" target="_blank"><i class="icon icon-history"></i></a>
                <a class="odfi" href="rule/Rule_tjsf.html" title="规则" target="_blank"><i class="icon icon-rule"></i></a>
        </div>
                    ...
                    <li id="nav4">
                        ...
                        <li id="nav4">
                                ...
                                <span class="eventtext" >
                                        <a href="tjsf.php" class="nav-item current">天津十分彩</a>

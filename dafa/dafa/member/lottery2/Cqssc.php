...
#left_1{
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1400);
...
<div class="block" style="padding:20px 0 0;">
<style>
...
<div id="dhlm">
	<ul id="hahahaha">
		<li style="margin-left:0px;" class="xuanzeyangshi"><a href="Cqssc.php" target="mainFrame">重庆时时彩</a></li>
...
.zxjg{width: 113px;text-align: center;height: 29px;line-height: 31px;}
 ...
 <div class="jsq">
	...
	<span class="ssc">&nbsp;重庆时时彩 <span style="float:right;margin-right:150px;">第 <font id="open_qihao">00000000-000</font>期</span>
...
<div class="jsq jsqllk">
	...
	<div style="float:right">
		<div class="zxjg"><a  href="/member/final/LT_result.php?gtype=CQ" title="开奖结果" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a></div>
		<div class="zxjg"><a  href="rule/Rule_Cqssc.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a></div>
	</div>

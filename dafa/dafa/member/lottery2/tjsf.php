...
<body style="width:982px;margin:0;">
    ...
    <div class="button">
        	<ul>
            	<li class="kg"><a  href="/member/final/LT_result.php?gtype=TJSF" title="开奖结果" target="_blank" ></a></li>
                <li class="gz"><a  href="rule/Rule_tjsf.html" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
<script type="text/javascript" src="js/tjsf.js?v=1005"></script>
...
<div id="dhlm">
	<ul id="hahahaha">
		...
		<li class="xuanzeyangshi"><a href="tjsf.php" target="mainFrame">天津十分彩</a></li>
...
<div class="ssc_left" style="width:1000px;">
   <!--  <div class="flash" style="margin-left: 20px;width: 785px;">
      <div class="f_left">
        <a href="rule/Rule_tjsf.html" title="游戏规则" target="_blank" class="laba" style="color:#FC0;font-size: 14px;">游戏规则</a>
      ...
      <div class="f_right">
          <div class="tops">天津快乐十分<span>第 <font id='numbers' class="red number">00000000-000</font> 期</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="/member/final/LT_result.php?gtype=TJSF" title="历史开奖" class="laba" style="color:#FC0" target="_blank">(历史开奖)</a></div>
...
.sj{  position: absolute;
 ...
 <div class="jsq">
    ...
    <span class="ssc">&nbsp;天津快乐十分 <span style="float:right;margin-right:112px;">
...
<div class="jsq jsqllk">
  ...
  <div class="kick "><img src='images/open_1/x.png'></div>
    ...
    <div style="float:right">
        ...
        <a href="/member/final/LT_result.php?gtype=TJSF" title="开奖结果" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a></div>
         
        <div class="zxjg"><a  href="rule/Rule_tjsf.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a></div>                     
    </div>
    ...
    <div class="touzhu">
<form name="orders" action="order/order_tjsf.php?1=1" method="post" target="OrderFrame">
<ul id="menu_hm">

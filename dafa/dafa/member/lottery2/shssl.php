...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1380);
...
$(window.parent.document).find("#mainFrame").height(920);
...
<div id="new_left" style="display: block;margin-left:0px !importnt;padding-top:40px;">
    <div style="width: 180px; float: left;margin-left:45px;  padding-top: 0px;" id="Left_scroll">
          <div id="ds_01_bet">
...
<div id="dhlm">
	<ul id="hahahaha">
		...
		<li class="xuanzeyangshi"><a href="shssl.php" target="mainFrame">上海时时乐</a></li>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      ...
      <a  href="/member/final/LT_result.php?gtype=T3" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a">
      <a  href="rule/Rule_ssl.html" title="游戏规则" target="_blank"></a></td>
...
.zxjg{width: 113px;text-align: center;height: 29px;line-height: 31px;}
 ...
 <div class="jsq">
    ...
    <span class="ssc">&nbsp;上海时时乐 <span style="float:right;margin-right:150px;">第 <font id="open_qihao">00000000-000</font>期</span>
...
<div class="jsq jsqllk">
    ...
    <div style="float:right">
        <div class="zxjg">
        <a  href="/member/final/LT_result.php?gtype=T3" title="开奖结果" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a>
  
         </div>
        <div class="zxjg">
        <a  href="rule/Rule_ssl.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a></div>
    </div> 

...
<style type="text/css">
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1350);
...
<div id="dhlm">
	<ul id="hahahaha">
		...
		<li class="xuanzeyangshi"><a href="pk10.php" target="mainFrame">北京PK拾</a></li>
...
.sj{ position: relative;
 ...
 <div class="jsq">
    ...
    <span class="ssc">&nbsp;北京PK10 <span style="float:right;margin-right:112px;">
 ...
 <div class="kick "><img src='images/Open_3/x1.png'></div>
    ...
    <div class="fot" id="autoinfo">开奖数据获取中...</div>
    		...
    		<!-- <div style="float:right">
    			...
    			<div class="zxjg">
    				<a href="/member/final/LT_result.php?gtype=BJPK" title="开奖结果" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a>
    			</div>
    			 
    			<div class="zxjg">
    				<a  href="rule/Rule_BjPk10.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a>
    			</div>                     
...
<table class="bian" border="0" cellpadding="0" cellspacing="1">
        <tr class="bian_tr_bg">
			 ...
			 <span style="float: right;position: relative;top: 27px;right: 17px;font-size: 13px;}">
			  <a href="/member/final/LT_result.php?gtype=BJPK" title="开奖结果" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a>
			  <a  href="rule/Rule_BjPk10.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a>
			  </span>
              </tr>

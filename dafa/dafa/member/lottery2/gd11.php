...
<body>
    ...
    <div class="button">
        	<ul>
                ...
                <li class="gz"><a  href="rule/Rule_gd11x5.html" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
body {
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1330);
...
<div id="dhlm">
	<ul id="hahahaha">
		...
		<li class="xuanzeyangshi"><a href="gd11.php" target="mainFrame">广东11选5</a></li>
	</ul>
</div>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      <td width="359" align="right"  valign="middle" class="kg_a"><a  href="/member/final/LT_result.php?gtype=GD11" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a"><a  href="rule/Rule_gd11x5.html" title="游戏规则" target="_blank"></a></td>
...
.shangqi{position: relative;top: -11px;}
 ...
 <div class="jsq">
	   ...
	   <img src='images/on.png' title='关闭/打开声音'/></span>&nbsp;&nbsp;
		...
		<span class="ssc">&nbsp;广东11选5 <span style="float:right;margin-right:150px;">第 <font id="open_qihao">00000000-000</font>期</span></span>
...
<div class="jsq jsqllk">
	...
	<div style="float:right">
		<div class="zxjg"><a href="/member/final/LT_result.php?gtype=GD11"  target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">开奖结果</a></div>
		<div class="zxjg"><a href="rule/Rule_gd11x5.html" title="游戏规则" target="_blank" style="text-decoration: none;color:#ccc;font-family:微软雅黑;">游戏规则</a></div>
	</div>

...
$bet_money_total = 0;
$win_money_total = 0;
$limits=user_group::getLimitAndFsMoney($userid);
$lowestMoney=$limits['cq_lower_bet'];
$maxMoney=$limits['cq_max_bet'];
...
$sql	=	"insert into order_lottery(user_id,Gtype,rtype_str,rtype,bet_info,bet_money,win,lottery_number,bet_time)
                    values ('$userid','$gType','快速-重庆时时彩','701','bet_info','$bet_money_total','0','$lottery_number','$bj_time_now')"; //新增一个投注项
$mysqli->query($sql);

...
<div id="bg_000">
    <div id="zhuce_top" style="margin: 0;width: auto;background-color: rgb(27, 17, 13);">
        <style type="text/css">
            #game_classify
            {
                width:960px;
        ...
        <script type="text/javascript">
            ...
            $(window.parent.parent.document).find("#mainFrame").height(780);
        </script>
        ...
        <div id="game_classify">
            <ul>
                ...
                <li class="icon_line">2、进入真人娱乐前请先进行额度转换，点击 <a style="font-size: 14px;" href="javascript:void(0);" onclick="zhuanhuan()" title="额度转换">额度转换</a> 选择【主账户->真人(普通厅)】马上转换额度</li>
                <li class="icon_line">3、额度转换提交后，系统会自动完成转账；用户进入 <a style="font-size: 14px;" href="javascript:void(0);" onclick="zhuanhuan()" title="额度转换">额度转换</a> 点击【查询转账记录】可查询额度转换的最新结果</li>
...
<script>
    $('#ele-game-open').on('click', function(){
		...
		//!------------------------------------------------------------
			...
			?>
		<div id="area-1" class="game-list clearfix" style="padding-left: 0;padding-top:0;width: 1000px;">
	...
	<div style="width:1000px">
	<img width="1000" border="0" src="/images/delar.jpg">
	</div>
</body>
</html>
<?

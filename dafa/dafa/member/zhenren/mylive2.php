...
#kk1{width:480px;margin:auto;min-height:100px;padding-bottom:50px;}

#kk1 a div{margin-left:23px;margin-top:10px;}

#bbin{width:480px;height:252px;background:url('baihencp.png');float:left;margin-left:0px !important;}

#mg{width:480px;height:252px;background:url('xianjincp.png');float:left;}

#mg1{width:480px;height:252px;background:url('bbcp.png');float:left;margin-left:0px !important;}

#lhc{width:480px;height:252px;background:url('lhccp.png');float:left;}
                        ...
                        <div id="kk">
						 ...
						 <a  href="javascript:;" onclick="if( logins() ){ click_url('/cpjk/playgame.php?ffc=ffc') }else{} " >
						
                      
                                    <div id="bbin"></div>
                                </a>

								<a onclick="click_url('/member/lt/?rtype=SPbside',1)" href="javascript:void(0);" >
                                    <div id="lhc"></div>
                                </a>
                                 <a href="javascript:;" onclick="click_url('/member/lottery/Cqssca.php?1=1')">
                                    <div id="mg1"></div>
                                </a>
                                <a href="javascript:;" onclick="click_url('/member/lottery/Cqssc.php?1=1')">
                                    <div id="mg"></div>
                                </a>
    ...
    $(window.parent.parent.document).find("#mainFrame").height(1005);

...
<div class="round-table">
    <form name="Frm_search_drawno"  id="Frm_search_drawno" method="get" onSubmit="return queryLottery();" method="get" action="/member/final1/LT_result.php">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="font12" style="margin-top:5px;" >
...
<!--    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="font12" style="margin-top:2px;" bgcolor="#798EB9">
        <tr  class="title_tr" style="background-color:#3C4D82; color:#FFF">
            ...
            <td align="center"><strong>一球</strong></td>
        ...
        while($rows = $query->fetch_array()){
            ...
            <tr   class="R_tr" align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                ...
                <td align="center" valign="middle">
                    <img src="/images/Lottery/Images/Ball_2/<?=$rows['ball_1']?>.png">
                    <img src="/images/Lottery/Images/Ball_2/<?=$rows['ball_2']?>.png">
                    <img src="/images/Lottery/Images/Ball_2/<?=$rows['ball_3']?>.png">
                    <img src="/images/Lottery/Images/Ball_2/<?=$rows['ball_4']?>.png">
                    <img src="/images/Lottery/Images/Ball_2/<?=$rows['ball_5']?>.png">
                    <span><?=Ssc_Auto($hm,1)?> / <?=(Ssc_Auto($hm,2)=="总和大"?"<span style=\"color: red;\">".Ssc_Auto($hm,2)."</span>":Ssc_Auto($hm,2))?> / <?=(Ssc_Auto($hm,3)=="总和双"?"<span style=\"color: red;\">".Ssc_Auto($hm,3)."</span>":Ssc_Auto($hm,3))?></span>
                    <span><?=(Ssc_Auto($hm,4)=="龙"?"<span style=\"color: red;\">".Ssc_Auto($hm,4)."</span>":Ssc_Auto($hm,4))?></span>
                    <span><?=Ssc_Auto($hm,5)?> / <?=Ssc_Auto($hm,6)?> / <?=Ssc_Auto($hm,7)?></span>
                    <span><?=$niuniu?> / <?=(b5_niuds($niuniu)=="牛双"?"<span style=\"color: red;\">".b5_niuds($niuniu)."</span>":b5_niuds($niuniu))?> / <?=(b5_niudx($niuniu)=="牛大"?"<span style=\"color: red;\">".b5_niudx($niuniu)."</span>":b5_niudx($niuniu))?></span>
                </td>
            </tr>  
        <?php
        }

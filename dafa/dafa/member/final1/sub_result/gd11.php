        ...
        while($rows = $query->fetch_array()){
            ...
            <tr   class="R_tr" align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                ...
                <td align="center" valign="middle">
                    <img src="/images/Lottery/Images/Ball_0/<?=BuLing($rows['ball_1'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0/<?=BuLing($rows['ball_2'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0/<?=BuLing($rows['ball_3'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0/<?=BuLing($rows['ball_4'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0/<?=BuLing($rows['ball_5'])?>.png">
                    <span><?=gd11x5_Auto($hm,1)?> / <?=(gd11x5_Auto($hm,2)=="总和大"?"<span style=\"color: red;\">".gd11x5_Auto($hm,2)."</span>":gd11x5_Auto($hm,2))?> / <?=(gd11x5_Auto($hm,3)=="总和双"?"<span style=\"color: red;\">".gd11x5_Auto($hm,3)."</span>":gd11x5_Auto($hm,3))?></span>
                    <span><?=(gd11x5_Auto($hm,4)=="龙"?"<span style=\"color: red;\">".gd11x5_Auto($hm,4)."</span>":gd11x5_Auto($hm,4))?></span>
                    <span><?=gd11x5_Auto($hm,5)?> / <?=gd11x5_Auto($hm,6)?> / <?=gd11x5_Auto($hm,7)?></span>
                </td>
            </tr>
        <?php
        }

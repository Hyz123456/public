        ...
        while($rows = $query->fetch_array()){
            ...
            <tr   class="R_tr" align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                ...
                <td align="center" valign="middle">
                    <img src="/images/Lottery/Images/Ball_0_GX/<?=BuLing($rows['ball_1'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0_GX/<?=BuLing($rows['ball_2'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0_GX/<?=BuLing($rows['ball_3'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0_GX/<?=BuLing($rows['ball_4'])?>.png">
                    <img src="/images/Lottery/Images/Ball_0_GX/<?=BuLing($rows['ball_5'])?>.png">
                    <span><?=gxsf_Auto($hm,1)?> / <?=(gxsf_Auto($hm,2)=="总和大"?"<span style=\"color: red;\">".gxsf_Auto($hm,2)."</span>":gxsf_Auto($hm,2))?> / <?=(gxsf_Auto($hm,3)=="总和双"?"<span style=\"color: red;\">".gxsf_Auto($hm,3)."</span>":gxsf_Auto($hm,3))?></span>
                    <span><?=(gxsf_Auto($hm,4)=="龙"?"<span style=\"color: red;\">".gxsf_Auto($hm,4)."</span>":gxsf_Auto($hm,4))?></span>
                    <span><?=gxsf_Auto($hm,5)?> / <?=gxsf_Auto($hm,6)?> / <?=gxsf_Auto($hm,7)?></span>
                </td>
            </tr> 
        <?php
        }

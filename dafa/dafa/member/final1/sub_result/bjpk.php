        ...
        while($rows = $query->fetch_array()){
            ...
            <tr   class="R_tr" align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                ...
                <td align="center" valign="middle">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_1']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_2']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_3']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_4']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_5']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_6']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_7']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_8']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_9']?>.png">
                    <img src="/images/Lottery/Images/Ball_3/<?=$rows['ball_10']?>.png">
                    <?php if(Pk10_Auto_quick($hm,1)==11){  ?>
                    <span><?=Pk10_Auto_quick($hm,1)?> / <em>和</em> / <em>和</em> </span>
                    <?php }else{  ?>
                    <span><?=Pk10_Auto_quick($hm,1)?> / <?=(Pk10_Auto_quick($hm,2)=="大"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,2)."</span>":Pk10_Auto_quick($hm,2))?> / <?=(Pk10_Auto_quick($hm,3)=="双"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,3)."</span>":Pk10_Auto_quick($hm,3))?></span>
                    <?php } ?>
                    <span><?=(Pk10_Auto_quick($hm,4)=="龙"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,4)."</span>":Pk10_Auto_quick($hm,4))?> / <?=(Pk10_Auto_quick($hm,5)=="龙"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,5)."</span>":Pk10_Auto_quick($hm,5))?> / <?=(Pk10_Auto_quick($hm,6)=="龙"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,6)."</span>":Pk10_Auto_quick($hm,6))?> / <?=(Pk10_Auto_quick($hm,7)=="龙"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,7)."</span>":Pk10_Auto_quick($hm,7))?> / <?=(Pk10_Auto_quick($hm,8)=="龙"?"<span style=\"color: red;\">".Pk10_Auto_quick($hm,8)."</span>":Pk10_Auto_quick($hm,8))?></span>
                </td>
            </tr>

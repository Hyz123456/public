...
<body style="width:982px;margin:0;">
	...
	<div id="new_left" style="display: block;z-index: 99999999;position: relative;">
...
$(window.parent.document).find("#mainFrame").height(1243);
...
<body style="background:url(/imgs/about_bg.png) repeat-x scroll 0 0 #8C5E00;font-size: 12px;">

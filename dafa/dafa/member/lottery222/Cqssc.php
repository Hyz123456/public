...
<body style="width:982px;">
    ...
    <div class="button">
        	<ul>
            	<li class="kg"><a  href="/member/final/LT_result.php?gtype=CQ" title="开奖结果" target="_blank" ></a></li>
                <li class="gz"><a  href="rule/Rule_Cqssc.html" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
body {
	...
	.drpbg .ca{font-size:12px; color:#fff;text-decoration:none;}
...
$(window.parent.document).find("#mainFrame").height(1400);
...
#img{width: 100%;height: 282px;background: url(cpyx.jpg)center no-repeat;margin-top: -18px;}
#img1{width:100%;height:331px;background:url('about_top.png')no-repeat center;margin-top:-109px;z-index: 9999;position:relative;}
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      <td width="359" align="right"  valign="middle" class="kg_a"><a  href="/member/final/LT_result.php?gtype=CQ" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a"><a  href="rule/Rule_Cqssc.html" title="游戏规则" target="_blank"></a></td>
...
<div class="iframe_por">    
	<iframe class="iframe" width="950" height="1027" src="http://777.dfapi.net/cl/?module=System&amp;method=Ltlottery" frameborder="0" scrolling="no"></iframe>
</div>
<style>
 .iframe_por{ width:910px; height:700px; margin:0 auto; overflow:hidden; position:relative;}

...
<body>
    ...
    <div class="button">
        	<ul>
            	<li class="kg"><a  href="/member/final/LT_result.php?gtype=JX" title="开奖结果" target="_blank" ></a></li>
                <li class="gz"><a  href="rule/Rule_jxssc.html" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
<script type="text/javascript" src="js/jx_ssc.js?v=1005"></script>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      <td width="359" align="right"  valign="middle" class="kg_a"><a  href="/member/final/LT_result.php?gtype=JX" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a"><a  href="rule/Rule_jxssc.html" title="游戏规则" target="_blank"></a></td>

  </tr>
</table>

    <div class="touzhu" style="margin-left: 20px;">
<form name="orders" action="order/order_jx_ssc.php?1=1" method="post" target="OrderFrame">
    	<ul id="menu_hm">

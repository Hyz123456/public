...
$(window.parent.document).find("#mainFrame").height(1300);
...
<!--内容开始-->
<div class="block" style="position: relative;left: 40px;top: 20px;z-index: 99999999;position: relative;">
...
<div id="new_left" style="display: block;">
    <div style="width: 180px; float: left; padding-top: 0px;" id="Left_scroll">
        <div id="ds_01_bet">
            <div id="left_1"><div id="left_1">投注选择</div></div>
...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="40">
  <tr  class="button_a">
      <td width="359" align="right"  valign="middle" class="kg_a"><a  href="/member/final/LT_result.php?gtype=GXSF" title="开奖结果" target="_blank" ></a></td>
      <td width="10">&nbsp;</td>
      <td width="391" align="left"  valign="middle" class="gz_a"><a  href="rule/Rule_gxsf.html" title="游戏规则" target="_blank"></a></td>

...
$(window.parent.document).find("#mainFrame").height(1146);
...
<div class="iframe_por">    
	<iframe class="iframe" width="1020" height="1200" src="http://777.gsoftbb.com/cl/?module=System&method=Ltlottery#&panel1-1" frameborder="0" scrolling="no"></iframe>
</div>
<style>
 .iframe_por{ width: 900px;
    height: 706px;
    margin: 0 auto;
    overflow: hidden;
    position: relative;}

            ...
            <td valign="top">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
                    <tr style="background-color:#3C4D82; color:#FFF">
                        ...
                        <td align="center"><strong>体育类别</strong></td>
                    ...
                    $sql.=" AND status!=0 AND status!=3 AND `check`!=0 ";
                    ...
                    if($bid){
                        ...
                        while ($rows = $query->fetch_array()) {
                            ...
                            <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                                ...
                                <td align="center" valign="middle"><?=$gtype?></td>
                                ...
                                <td align="center" valign="middle"><?=$rows['bet_point']?></td>
                                <td align="center" valign="middle"><?=$rows['win']+$rows['fs']?></td>
                                <td align="center" valign="middle" style="width: 120px;">北京:<?=$rows['bet_time']?><br/>美东:<?=$rows['bet_time_et']?></td>
                                <td align="center" valign="middle"><?=$row_sub['user_name']?></td>
                                <td  style="min-width: 35px;"><?php if($rows['status']==0){?><font >未结算</font><?php }?>

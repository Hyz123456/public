        ...
        <tr>
            <td valign="top">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
                    ...
                    $sport_result = report_sport::getAllBetMoneyAndCount($s_time,$e_time,$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $cg_result = report_sport::getBetMoneyAndCountCg($s_time,$e_time,$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $lottery_result = lottery_order::getAllBetMoneyAndCount($s_time,$e_time,$inUserString," AND o.status!=0 AND o.status!=3 AND o_sub.is_win!=2 ");
                    $lhc_result = six_lottery_order::getBetMoneyAndCount($s_time,$e_time,$inUserString," AND o.status!=0 AND o.status!=3 AND o_sub.is_win!=2 ");
                    $live_result = report_live::getLiveBetMoneyAndCount($s_time,$e_time,$inUserString);

                    $sport_win = report_sport::getAllTotalWin($s_time,$e_time,$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $cg_win = report_sport::getTotalWinCg($s_time,$e_time,$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $lottery_win = lottery_order::getAllTotalWin($s_time,$e_time,$inUserString," AND o.status!=0 AND o.status!=3 AND o_sub.is_win!=2 ");
                    $lhc_win = six_lottery_order::getTotalWin($s_time,$e_time,$inUserString," AND o.status!=0 AND o.status!=3 AND o_sub.is_win!=2 ");
                    ...
                    $total_bet_count = $sport_result["bet_count"] + $cg_result["bet_count"]
                                        + $lottery_result["bet_count"] + $lhc_result["bet_count"]+$live_result["bet_count"];
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="真人娱乐" style="color: #F37605;" href="live_order_details.php?s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">真人娱乐</a>
                        </td>
                        <td align="center" valign="middle"><?=$live_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$live_result["bet_money_total"]-0?></td>
                        <td align="center" valign="middle">----</td>
                        <td align="center" valign="middle"><?=0-$live_result["win_total"]?></td>
                    </tr>
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        ...
                        <td align="center" valign="middle"><?=$total_bet_money+$live_result["bet_money_total"]?></td>
                        <td align="center" valign="middle"><?=$total_win_money?></td>
                        <td align="center" valign="middle"><?=$total_bet_money - $total_win_money-$live_result["win_total"]?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle" colspan="5">赢取金额=下注金额-下注结果。如果是正数，说明赢钱，如果是负数，则为输钱。</td>
                    </tr>

                    <tr style="display: none;background-color:#3C4D82; color:#FFF">
                        <td style="width: 16%" align="center" height="25"><strong>游戏名称</strong></td>
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px; display: none;">
                        <td height="25" align="center" valign="middle" colspan="5">盈利金额=成功转入总金额-成功转出总金额。如果是正数，说明赢钱，如果是负数，则为输钱。</td>
                    </tr>

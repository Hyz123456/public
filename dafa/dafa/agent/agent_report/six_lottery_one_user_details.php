...
$sql_user = "select user_name,money from user_list where user_id='".$_GET["user_id"]."'";
                    ...
                    <form name="form1" id="form1" method="get" action="<?=$_SERVER["REQUEST_URI"]?>" onSubmit="return check();">
                        <tr>
                            <td align="left" bgcolor="#FFFFFF">
                                <a title="返回上一页" style="color: #F37605;"  href="six_lottery_history.php?s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$rows_user["user_name"]?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">返回上一页</a>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#FFFFFF">
...
<!--                        </tr>-->
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
                    ...
                    $sql .= " AND o.user_id='".$_GET["user_id"]."'";
...
//                    if($_GET['tf_id']) $sql.=" and o_sub.order_sub_num=".$_GET['tf_id']."";
                    $sql.=" AND o.status!=0 AND o.status!=3 AND o_sub.is_win!=2 ";
                    ...
                    if($bid){
                        ...
                        $sql	=	"SELECT o.lottery_number AS qishu,o.rtype_str,o.bet_time,o.order_num,
                                                ...
                                                o_sub.bet_rate AS bet_rate_one,o_sub.is_win,o_sub.status, o.user_id,

...
<style>
#right_bg {
    background: url(/admin/images/Yloading.gif) no-repeat center;
    background-size: 35%;
}
</style>
...
<frameset cols="195,*" id="frame">
	...
	<frame src="agents_user/report.php?id=<?=$_SESSION["agent_id"]?>" id="right_bg" name="main" marginwidth="0" marginheight="0" frameborder="0" scrolling="yes">
</frameset>

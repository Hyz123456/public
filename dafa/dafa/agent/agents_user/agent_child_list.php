...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="font12" bgcolor="#ccc">
    <tr>
        <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">下属会员信息</span></font></td>
    </tr>
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
    <tr style="background-color:#5a5a5a; color:#FFF">
        <td style="width: 10%" align="center" height="25"><strong>下属会员名</strong></td>
        <td style="width: 10%" align="center"><strong>帐户余额</strong></td>
        ...
        <td style="width: 10%" align="center"><strong>注册时间</strong></td>
		<td style="width: 11%" align="center"><strong>加钱</strong></td>
    </tr>
    <?php
    ...
    if($bid){
        $bid	=	rtrim($bid,',');
        $sql_main = "select id,user_id,user_name,regtime,money from user_list where id in($bid) ORDER BY money DESC ";
        ...
        foreach($list_main as $key => $value){
            ...
            <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
		        ...
		        <td align="center" valign="middle" style="color:#C82721;"><?=$value['money']?></td>

...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
        <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">代理管理：查看结算明细</span></font></td>
    </tr>
</table>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" style="margin-top: 10px;">
        <tr>
            <td height="24" nowrap bgcolor="#FFFFFF">
                ...
                <table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color: #225d9c;" id=editProduct   idth="100%" >       <tr style="background-color: #EFE;line-height:1.5em" class="bg_tr"   align="center">

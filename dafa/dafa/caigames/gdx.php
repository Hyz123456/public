...
<html>
	...
	<body>
		...
		<aside>
			...
			<?php 
				...
				$sql='select max(qishu) as qishu from lottery_result_gd11';
				$query=$mysqli->query($sql) or die('error!');
				$arr=$query->fetch_array();

				$mq=$arr['qishu'];
				$sql='select * from lottery_result_gd11 where qishu="'.$mq.'"';
				$query=$mysqli->query($sql) or die('error!');
			...
			<div  class="lottery_kind">
				<a href="javascript:;" class="active">广东11选5</a>
	...
	<section class="lotterListBox">
		...
		<form action="../member/lottery/order/order_gd11.php?style=wap" method="post" id="fomes"  class='box'>
			...
			<div class="numBox">
				...
				<?php
						$sql="select * from odds_lottery where sub_type='正码和特别号' and lottery_type='广东十一选五' and ball_type='ball_".$j."' ";
						$query=$mysqli->query($sql) or die('error!');
						$arr=$query->fetch_array();
				?>
				...
				?>
				<p>
					<dis><span class="bg_blue">11</span>
					<span><?=$arr['h11']?></span>
			...
			<div class="numBox">
				...
				<?php
					$sql="select * from odds_lottery where sub_type='总和龙虎和' and lottery_type='广东十一选五' ";
					$query=$mysqli->query($sql) or die('error!');
					$arr=$query->fetch_array();
				?>
...
<div class="popover-backdrop">
    <div class="popover-wrapper">
        <div class="list"> 
            <a href="/member/final1/LT_result.php?gtype=GD11" >开奖历史</a>
        </div>

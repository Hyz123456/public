...
<html>
	<head>
		...
		<aside>
			...
			<?php 
				...
				$sql='select max(qishu) as qishu from lottery_result_cqsf';
				$query=$mysqli->query($sql) or die('error!');
				$arr=$query->fetch_array();

				$mq=$arr['qishu'];
				$sql='select * from lottery_result_cqsf where qishu="'.$mq.'"';
				$query=$mysqli->query($sql) or die('error!');
			...
			<div  class="lottery_kind">
				<a href="javascript:;" class="active">重庆快乐十分</a>
	...
	<section class="lotterListBox">
		...
		<form action="../member/lottery/order/order_cqsf.php?style=wap" method="post" id="fomes"  class='box'>
			...
			<div class="numBox">
				...
				<?php
						$sql="select * from odds_lottery where sub_type='正码和特别号' and lottery_type='重庆十分彩' and ball_type='ball_".$j."' ";
						$query=$mysqli->query($sql) or die('error!');
						$arr=$query->fetch_array();

						$sql="select * from odds_lottery where sub_type='方位中发白' and lottery_type='重庆十分彩' and ball_type='ball_".$j."' ";
						$query=$mysqli->query($sql) or die('error!');
			...
			<div class="numBox">
				...
				<?php
					$sql="select * from odds_lottery where sub_type='总和龙虎' and lottery_type='重庆十分彩' ";
					$query=$mysqli->query($sql) or die('error!');
					$arr=$query->fetch_array();
				?>
		...
		<script>
			...
			(function(){
					function updateOpenTime(){
						$.post("../member/lottery/class/odds_cqsf.php", function(data){

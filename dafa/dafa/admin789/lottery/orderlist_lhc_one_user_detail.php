...
<tr>
    <td height="24" nowrap background="../images/06.gif">
        <font ><span class="STYLE2">六合彩注单查询（<a href="../webconfig/index.php" style="color: #F37605;font-size: 14px;" target="main">设置页面属性</a>）</span></font>
        &nbsp;&nbsp;<a title="返回上一页" style="color: #F37605;"  href="orderlist_lhc_user.php?s_time=<?=$_GET['s_time']?>&amp;e_time=<?=$_GET['e_time']?>&amp;js=<?=$_GET["js"]?>&amp;qishu=<?=$_GET["qishu"]?>">返回上一页</a>
    </td>
</tr>
<tr>

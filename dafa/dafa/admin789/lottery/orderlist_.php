...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
            <td height="24" nowrap background="../images/06.gif"><font ><span class="STYLE2">彩票注单查询（<a href="../webconfig/index.php" style="color: #F37605;font-size: 14px;" target="main">设置页面属性</a>）</span></font></td>
        </tr>
        <tr>
...
//                            }
                            ...
                            <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                                ...
                                <td><?php if($rows['status']==0){?><font color="#0000FF">未结算</font>--<a onclick='cancelOrder_lottery("<?=$rows['id']?>")' title="作废该单"><font color="#ffcccc">作废</font></a><?php }?>

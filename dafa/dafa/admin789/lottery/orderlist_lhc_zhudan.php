...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
        <td height="24" nowrap class="bg_tr"><font ><span class="STYLE2">六合彩注单查询(按注单)（<a href="../webconfig/index.php" style="color: #F37605;font-size: 14px;" target="main">设置页面属性</a>）</span></font></td>
    </tr>
    <tr>
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
                    ...
                    if($bid){
                        ...
                        while ($rows = $query->fetch_array()) {
                            ...
                            $image_path = "/order/six_lottery_order/".substr($order_sub_num,0,8)."/$order_sub_num.jpg";
                            ?>

...
if($_GET["action"]=="add" && $id==0){
    ...
    $query	=	$mysqli->query($sql);
    if($query){echo '<script>alert("删除成功"); window.href.location="/admin/Lottery/result/GXSF/result_gxsf.php?status=0&type=%E5%B9%BF%E8%A5%BF%E5%8D%81%E5%88%86%E5%BD%A9";</script>';}
...
<tr>
    ...
    <td  align="left" bgcolor="#5a5a5a" style="color:#FFF"><strong>广西十分彩</strong></td>
</tr>
<tr>

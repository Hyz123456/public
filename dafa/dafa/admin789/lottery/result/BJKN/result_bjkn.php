...
if($_GET["action"]=="add" && $id==0){
    ...
    $query	=	$mysqli->query($sql);
	if($query){echo '<script>alert("删除成功"); window.href.location="/admin/Lottery/result/BJKN/result_bjkn.php?status=0&type=%E5%8C%97%E4%BA%AC%E5%BF%AB%E4%B9%908";</script>';}
	else{echo '<script>alert("删除失败"); window.href.location="/admin/Lottery/result/BJKN/result_bjkn.php?status=0&type=%E5%8C%97%E4%BA%AC%E5%BF%AB%E4%B9%908";</script>';}
...
?>
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:4px;" bgcolor="#ccc">
<tr>
    <td  align="left" bgcolor="#5a5a5a" style="color:#FFF">彩票类别：</td>
    <td  align="left" bgcolor="#5a5a5a" style="color:#FFF"><strong>北京快乐8</strong></td>
</tr>
<tr>
...
<tr>
    ...
    <select name="ball_15" id="ball_15" style="margin-top:4px;">
    ...
    <select name="ball_16" id="ball_16" style="margin-top:4px;">
    ...
    <select name="ball_17" id="ball_17" style="margin-top:4px;">
    ...
    <select name="ball_18" id="ball_18" style="margin-top:4px;">
    ...
    <select name="ball_19" id="ball_19" style="margin-top:4px;">
    ...
    <select name="ball_20" id="ball_20" style="margin-top:4px;">
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:4px;" >

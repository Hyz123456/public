...
<head>
    ...
    <link rel="stylesheet" href="/style/member/pitaya_odds_settings.css?31742e1"/>
    ...
    <script src="../lottery/oddssetting/B5/saveOdds.js"></script>
    ...
    <script src="/js/PC/b5_odds_settings.js?31742e6"></script>
...
<h2>
    <b></b>
    <span style="color:#333333;">'.$lottery_name.'-赔率设置'.'</span>
</h2>
...
<div id="content_inner">
    ...
    <div>
        <div id="wager_groups" style="display:none" class="'.$gType.'">
            ...
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=506"  title="总和龙虎和">总和龙虎和</a>
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=511"  title="豹子顺子">豹子顺子</a>
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=701"  title="牛牛">牛牛</a>
        </div>
    </div>
</div>
<!--rtype选择-->

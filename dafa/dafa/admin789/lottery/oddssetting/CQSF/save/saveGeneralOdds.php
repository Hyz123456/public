...
if(strpos($quanxian,'修改彩票赔率')){
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_1[0]', h2='$ball_1[1]', h3='$ball_1[2]', h4='$ball_1[3]',
                ...
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_1'";
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_2[0]', h2='$ball_2[1]', h3='$ball_2[2]', h4='$ball_2[3]',
                ...
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_2'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第二球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_3[0]', h2='$ball_3[1]', h3='$ball_3[2]', h4='$ball_3[3]',
                ...
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_3'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第三球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_4[0]', h2='$ball_4[1]', h3='$ball_4[2]', h4='$ball_4[3]',
                ...
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_4'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第四球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_5[0]', h2='$ball_5[1]', h3='$ball_5[2]', h4='$ball_5[3]',
                ...
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_5'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第五球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_6[0]', h2='$ball_6[1]', h3='$ball_6[2]', h4='$ball_6[3]',
                                          h5='$ball_6[4]', h6='$ball_6[5]', h7='$ball_6[6]', h8='$ball_6[7]'
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_6'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第六球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_7[0]', h2='$ball_7[1]', h3='$ball_7[2]', h4='$ball_7[3]',
                                          h5='$ball_7[4]', h6='$ball_7[5]', h7='$ball_7[6]', h8='$ball_7[7]'
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_7'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第七球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_8[0]', h2='$ball_8[1]', h3='$ball_8[2]', h4='$ball_8[3]',
                                          h5='$ball_8[4]', h6='$ball_8[5]', h7='$ball_8[6]', h8='$ball_8[7]'
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_8'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,第八球。';
        exit;
    ...
    $sql	=	"UPDATE odds_lottery SET h1='$ball_9[0]', h2='$ball_9[1]', h3='$ball_9[2]', h4='$ball_9[3]',
                                          h5='$ball_9[4]', h6='$ball_9[5]', h7='$ball_9[6]', h8='$ball_9[7]'
                WHERE lottery_type='广东十分彩' AND sub_type='主盘势' AND ball_type='ball_9'";
    $result = $mysqli->query($sql);
    if(!$result){
        echo '保存失败,总和。';
        exit;

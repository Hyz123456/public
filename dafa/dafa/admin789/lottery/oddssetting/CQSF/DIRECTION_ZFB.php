...
$odds1 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_1");
$odds2 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_2");
$odds3 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_3");
$odds4 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_4");
$odds5 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_5");
$odds6 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_6");
$odds7 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_7");
$odds8 = odds_sf::getOddsByBall("重庆十分彩","方位中发白","ball_8");

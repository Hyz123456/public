...
$odds1 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_1");
$odds2 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_2");
$odds3 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_3");
$odds4 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_4");
$odds5 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_5");
$odds6 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_6");
$odds7 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_7");
$odds8 = odds_sf::getOddsByBall("天津十分彩","四季五行","ball_8");//特别号

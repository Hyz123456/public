            ...
            <div id="content-inner">
                ...
                <div class="GXSF"
                    ...
                    <div id="view-groups" style="display: none;">
                        <a title="主盘势" group="GENERAL" href="#/GXSF/GENERAL">主盘势</a>
                        <a title="特别号" group="SP" href="#/GXSF/SP">特别号</a>
                        <a title="四季五行" group="SEASONS_ELEMENTS" href="#/GXSF/SEASONS_ELEMENTS">四季五行</a>
                        <a title="正码特" group="NORMAL_NUMBER" href="#/GXSF/NORMAL_NUMBER">正码特</a>
                        <a title="一中一" group="CHOOSE_1_MATCH_1" href="#/GXSF/CHOOSE_1_MATCH_1">一中一</a>
                        <a title="总和/龙虎" group="ALLSUM_DRAGON_TIGER" href="#/GXSF/ALLSUM_DRAGON_TIGER">总和/龙虎</a>
                        <a title="顺子杂六" group="SHUNZI" href="#/GXSF/SHUNZI">顺子杂六</a>
                    </div>
...
<script type="text/javascript" src="../lottery/oddssetting/GXSF/saveOdds.js?1390801674"></script>
<script>
    var interval_num = 0;
    function myfun(){

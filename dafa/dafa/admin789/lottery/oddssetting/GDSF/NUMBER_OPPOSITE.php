...
$odds1 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_1");
$odds2 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_2");
$odds3 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_3");
$odds4 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_4");
$odds5 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_5");
$odds6 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_6");
$odds7 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_7");
$odds8 = odds_sf::getOddsByBall("广东十分彩","单面双码","ball_8");

            ...
            <div id="content-inner">
                ...
                <div class="GDSF"
                    ...
                    <div id="view-groups" style="display: none;">
                        <a title="主盘势" group="GENERAL" href="#/GDSF/GENERAL">主盘势</a>
                        <a title="单码双面" group="NUMBER_OPPOSITE" href="#/GDSF/NUMBER_OPPOSITE">单码双面</a>
                        <a title="四季五行" group="SEASONS_ELEMENTS" href="#/GDSF/SEASONS_ELEMENTS">四季五行</a>
                        <a title="方位/中发白" group="DIRECTION_ZFB" href="#/GDSF/DIRECTION_ZFB">方位/中发白</a>
                        <a title="总和/龙虎" group="ALLSUM_DRAGON_TIGER" href="#/GDSF/ALLSUM_DRAGON_TIGER">总和/龙虎</a>
                        <a title="一中一" group="CHOOSE_1_MATCH_1" href="#/GDSF/CHOOSE_1_MATCH_1">一中一</a>
                    </div>
...
<script type="text/javascript" src="../lottery/oddssetting/GDSF/saveOdds.js?1390801674"></script>
<script>
    var interval_num = 0;
    function myfun(){

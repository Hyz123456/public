...
if($save=="ok"){
	...
	*/
	...
	if(file_put_contents($_SERVER['DOCUMENT_ROOT']."\app\member\cache\ltConfig.php",$str.'?>')>0){
		message("设置成功!","?1=1");
	}else{
		message("缓存文件写入失败！请先设/app/member/cache/ltConfig.php检查是否有写入权限");
	}
...
<body>
<div id="pageMain">
    <table width="100%" border="0" align="center" cellpadding="8" cellspacing="1" class="font12" bgcolor="#ccc" style="margin-top:5px;">
        <tr>
            <td align="center" bgcolor="#5a5a5a" style="color:#FFF">
                时时彩设置</td>
        </tr>
    </table>

    <table border="0"align="center" cellspacing="1" cellpadding="5" width="100%" class="font12" style="margin-top:5px;" bgcolor="#ccc">

...
if($_GET["action"]=="add" && $id==0){
    ...
    $query	=	$mysqli->query($sql);
	if($query){echo '<script>alert("删除成功"); window.href.location="/admin/Lottery/result/LHC/result_lhc.php?type=%E5%85%AD%E5%90%88%E5%BD%A9";</script>';}
	else{echo '<script>alert("删除失败"); window.href.location="/admin/Lottery/result/LHC/result_lhc.php?type=%E5%85%AD%E5%90%88%E5%BD%A9";</script>';}
}
...
<tr>
    ...
    <td  align="left" bgcolor="#5a5a5a" style="color:#FFF"  colspan="5"><strong><?=$lottery_type?></strong></td>
</tr>
<tr>

...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">AG电子注单管理：查看所有注单情况（注单为美东时间）</span></font></td>
  </tr>
  <tr>
...
<?php 
      $sql	=	"select a.id from api_agbetdetail a,user_list u where a.platformType='xin' and a.username=u.user_name ";
	  ...
	  if($bid){
	  	$bid	=	rtrim($bid,',');
	  	$sql="select a.*,b.user_name from (select * from api_agbetdetail where id in($bid)) a left join user_list b 
      on a.username=b.user_name order by a.betTime desc";
	  	$query	=	$mysqli->query($sql);

...
<tr bgcolor="efe" class="bg_tr" align="center">
    ...
    <td style="width: 10%" align="center">
        <strong>
            反水比例&nbsp;
            <input id="setAllFsRate" type="button" onclick="setAllFsRate();" value="设置所有玩家"/style="color: #F37605;">
        </strong></td>
    <td style="width: 10%" align="center">
        <strong>
            操作&nbsp;
            <input id="setAllFs" name="fs_button" type="button" onclick="setAllFs();" value="反水本页玩家"/style="color: #F37605">
        </strong>
    </td>
</tr>
<?php
    ...
    if($i >= $start && $i <= $end){
        ...
        <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px; <? if($row_user["user_name"]){}else{echo 'display:none;'; } ?>">
            ...
            <td align="center" valign="middle">
                ...
                <input id="setFs<?=$user_id?>" type="button" name="setFs" onclick="setFs(<?=$user_id?>);" value="设置"/style="color: #F37605;">
            </td>
            <td align="center" valign="middle">
                <input id="fs_button_<?=$user_id?>" type="button" name="fs_button" onclick="fs_one('<?=$row['live_username']?>');" value="反水单个玩家"/style="color: #F37605;">
            </td>
        </tr>
    <?php
    }

...
function update_auto(){
	window.open('/newna2/getall.php','list','width=440,height=180,left=50,top=100,scrollbars=no').focus();
}
</script>
</HEAD>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">NA真人报表</span></font></td>
  </tr>
  <tr>
...
<?php 
		$sql = "SELECT na_username FROM user_list where na_username!='' ";
		...
		if($query)
      	...
      	?>
	        <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>;">
			  <td  align="center" class='ag_name' ><?php echo $rows['na_username']?></td>

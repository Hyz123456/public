...
<?php 
      ...
      $sql	=	"select a.id from agbetdetail a,user_list u where a.platformType = 'BBIN' and a.gameCode!='bbdz' and a.gameCode!='bbcp' and a.gameCode!='bbty' and a.playerName=u.bb_username ";

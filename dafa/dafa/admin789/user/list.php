                    ...
                    if($uid){
                        ...
                        while($rows = $query->fetch_array()){
                            ...
                            <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>">
                                ...
                                <td>
                                    ALLBet:<span id="<?='ALLBet'.$rows["user_name"]?>" >--</span><a href="javascript:void(0);" onClick="reflivemoney('<?=$rows["user_name"]?>','ALLBet')">&nbsp;刷新</a><br/>
                                    AG:<span id="<?='ag'.$rows["user_name"]?>" >--</span><a href="javascript:void(0);" onClick="reflivemoney('<?=$rows["user_name"]?>','ag')">&nbsp;刷新</a><br/>
                                    bbin:<span id="<?='bbin'.$rows["user_name"]?>" >--</span><a href="javascript:void(0);" onClick="reflivemoney('<?=$rows["user_name"]?>','bbin')">&nbsp;刷新</a><br/>
                                    MG:<span id="<?='mg'.$rows["user_name"]?>" >--</span><a href="javascript:void(0);" onClick="reflivemoney('<?=$rows["user_name"]?>','mg')">&nbsp;刷新</a><br/>
                                    pt:<span id="<?='pt'.$rows["user_name"]?>" >--</span><a href="javascript:void(0);" onClick="reflivemoney('<?=$rows["user_name"]?>','pt')">&nbsp;刷新</a>
                                </td>
...
<script language="javascript">
    function reflivemoney(username,index) {
        ...
        com.html('<img style="width: 20px;height: 20px;" src="../../images/loading.gif" />');
        $.get("../../agline/live_money_admin.php?username="+username+"&index="+index,function (data) {
            com.html(data);
        });
    }
</script>

...
$key = rand(0,2);
$stringColor = ImageColorAllocate($im,rand(0,255),rand(0,255),rand(0,255)); //字体颜色
$backColor = ImageColorAllocate($im,rand(0,255),rand(0,255),rand(0,255));//背景色（随机）
$borderColor = ImageColorAllocate($im, 73, 185, 219);//边框色

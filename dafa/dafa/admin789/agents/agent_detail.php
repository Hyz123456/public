...
<table width="90%" align="center" border="1" bgcolor="#FFFFFF" bordercolor="#CCC" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color: #225d9c;"  >
  ...
  <tr>
    ...
    <td><input name="agents_pass" <?php if($_GET["id"]){ ?> readonly <?php } ?> id="agents_pass" value="<?=$rows["agent_pass_naked"]?>"></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF">取款密码</td>
    <td><input name="qk_pass" <?php if($_GET["id"]){ ?> readonly <?php } ?> id="qk_pass" value="<?=$rows["qk_pass_naked"]?>"></td>
  </tr>
  <tr>

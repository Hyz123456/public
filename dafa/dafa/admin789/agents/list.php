    ...
    function check(){
        ...
        if(num){
            ...
            if(action=="0"){
                ...
                if(action=="4"){
                    if(confirm('确认一键结算？一键结算默认的时间范围为昨天时间所在的那个月的1号至昨天时间!!!')){
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
        <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">代理管理：查看代理的信息</span></font></td>
    </tr>
    <tr>

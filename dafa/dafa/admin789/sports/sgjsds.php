...
<body>
<div id="pageMain">
    <table width="100%" height="auto" border="0" cellspacing="0" cellpadding="5">
        <tr>
            <td height="24" nowrap class="bg_tr"><font ><span class="STYLE2">体育注单查询（<a href="../webconfig/index.php" style="color: #F37605;font-size: 14px;" target="main">设置页面属性</a>）</span></font></td>
        </tr>
        <tr>
            <td valign="top">
...
//									$over = $out = $color = "#FBA09B";
                            ...
                            <tr >
                                <td colspan="11" style="padding: 0px;"><img style="max-width: 100%;" src="/app/member/images/t_ico.gif">
                                </td>
                            </tr>
                        <?php
                        }

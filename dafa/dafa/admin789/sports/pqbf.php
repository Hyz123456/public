...
?>
        ...
        <td width="200" align="center"><label>
          <input type="button" name="Submit" value="刷新排球" onClick="window.location.reload();">
        </label></td>
		<td width="200"><a href="pqbf.php?date=<?=$page_date?>&look=1" style="font-size:13px;">&gt;&gt;只看有下注的赛事</a></td>
  ...
  <table   border="0" cellspacing="1" cellpadding="5"  bgcolor="006255" width="100%" height="41">
	...
	$sql		=	"SELECT ID,Match_ID,Match_Time,Match_Master,Match_Guest,Match_Name,MB_Inball,TG_Inball FROM volleyball_match where match_js=0 and match_date='$page_date' order by Match_CoverDate,match_name,Match_Master desc";

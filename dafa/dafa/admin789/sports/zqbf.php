...
?>
        ...
        <td width="300" align="center"><span class="STYLE4">相关操作：</span>
  ...
  <table   border="0" cellspacing="1" cellpadding="5"  bgcolor="#ccc" width="100%" height="41">
    <tr class="m_title_ft"> 
      ...
      <th align="middle">全场比分</th>
      <th align="middle"><label>
    ...
    <tr style="background-color:#ffffff"   align="center" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#ffffff'"> 
      ...
      <td width="210"><div align="center" style="padding-right:5px;"><?=$rows["Match_Master"]?></div></td>
      <td width="210"><div align="center" style="padding-left:5px;"><?=$rows["Match_Guest"]?></div></td>
	  <td width="50"><div align="center" style="padding-left:5px;"><?if($cou>0){?><a href="orderlist.php?status=all&type=足球&match_id=<?=$rows["Match_ID"]?>&s_time=<?=date('Y-m-d',strtotime('-13 day'))?>"><?=$cou?></a><?}else{echo '0';}?></div></td>
	  <td width="50"><div align="center" style="padding-left:5px;"><?if($cou_cg>0){?><a href="cg_list.php?status=all&type=足球&gid_group=<?=$gid_group?>&s_time=<?=date('Y-m-d',strtotime('-13 day'))?>"><?=$cou_cg?></a><?}else{echo '0';}?></div></td>
     <td width="100">

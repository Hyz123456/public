...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="24" nowrap class="bg_tr"><font ><span class="STYLE2">冠军管理：管理冠军栏目情况</span></font></td>
  </tr>
  <tr>
		...
		$cou=0;
      	...
      	?>
	        <tr align="center" onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#ffffff'" style="background-color:#FFFFFF;">
              ...
              <td><?=$rows["add_time"]?></td>
			  <td width="50"><div align="middle" style="padding-left:5px;"><?if($cou>0){?><a href="orderlist.php?status=all&type=冠军&match_id=<?=$rows["match_id"]?>&s_time=<?=date('Y-m-d',strtotime('-365 day'))?>"><?=$cou?></a><?}else{echo '0';}?></div></td>

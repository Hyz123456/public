        ...
        <tr>
            <td valign="top">
                    ...
                    <form name="form1" id="form1" method="get" action="<?=$_SERVER["REQUEST_URI"]?>" onSubmit="return check();">
                        <tr>
                            <td align="left" bgcolor="#FFFFFF">
                                <a title="返回上一页" style="color: #F37605;"  href="bhdz_details.php?s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;date_month=<?=$date_month?>">返回上一页</a>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#FFFFFF">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
                    ...
                    $sql	=	"select  u.id  FROM user_list u,agbetdetail a where a.playerName=u.dx_username and a.platformType='dxdz' ";
                    ...
                    if($bid){
                        $bid	=	rtrim($bid,',');
                        $sql	=	"SELECT a.* FROM agbetdetail  a ,user_list u where a.playerName =u.dx_username and  a.platformType='dxdz' ";
                    ...
                    <tr style="background-color:#FFFFFF;">
                        <td colspan="11" align="center" valign="middle">当前页总投注金额:<?=0-$t_allmoney?>元 &nbsp;&nbsp;   当前页赢取金额:<?=$t_sy?>元</td>
                    </tr>
                    <tr style="background-color:#FFFFFF;">

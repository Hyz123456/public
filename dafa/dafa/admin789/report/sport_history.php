        ...
        <tr>
            <td valign="top">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
                    ...
                    $ft_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"足球",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $bk_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"篮球",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $tn_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"网球",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $vl_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"排球",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $bs_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"棒球",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $gj_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"冠军",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $ds_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"单式",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $cg_result_valid = report_sport::getBetMoneyAndCountCg($s_time,$e_time,$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    $other_result_valid = report_sport::getBetMoneyAndCount($s_time,$e_time,"其他",$inUserString," AND status!=0 AND status!=3 AND `check`!=0 ");
                    ...
                    $total_bet_money_valid = $ft_result_valid["bet_money"] + $bk_result_valid["bet_money"]
                        + $tn_result_valid["bet_money"] + $vl_result_valid["bet_money"]+ $bs_result_valid["bet_money"]
                        + $gj_result_valid["bet_money"]+ $cg_result_valid["bet_money"]+ $other_result_valid["bet_money"];
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="足球" style="color: #F37605;"  href="sport_user.php?gtype=<?=urldecode('足球')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">足球</a>
                        </td>
                        <td align="center" valign="middle"><?=$ft_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$ft_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$ft_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$ft_win+0?></td>
                        <td align="center" valign="middle"><?=$ft_result["bet_money"]-$ft_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="篮球" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('篮球')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">篮球</a>
                        </td>
                        <td align="center" valign="middle"><?=$bk_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$bk_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$bk_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$bk_win+0?></td>
                        <td align="center" valign="middle"><?=$bk_result["bet_money"]-$bk_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="网球" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('网球')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">网球</a>
                        </td>
                        <td align="center" valign="middle"><?=$tn_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$tn_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$tn_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$tn_win+0?></td>
                        <td align="center" valign="middle"><?=$tn_result["bet_money"]-$tn_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="排球" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('排球')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">排球</a>
                        </td>
                        <td align="center" valign="middle"><?=$vl_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$vl_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$vl_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$vl_win+0?></td>
                        <td align="center" valign="middle"><?=$vl_result["bet_money"]-$vl_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="棒球" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('棒球')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">棒球</a>
                        </td>
                        <td align="center" valign="middle"><?=$bs_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$bs_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$bs_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$bs_win+0?></td>
                        <td align="center" valign="middle"><?=$bs_result["bet_money"]-$bs_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="冠军" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('冠军')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">冠军</a>
                        </td>
                        <td align="center" valign="middle"><?=$gj_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$gj_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$gj_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$gj_win+0?></td>
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        ...
                        <td align="center" valign="middle"><?=$cg_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$cg_win+0?></td>
                        <td align="center" valign="middle"><?=$cg_result["bet_money"]-$cg_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="其他" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('其他')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">其他</a>
                        </td>
                        <td align="center" valign="middle"><?=$other_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$other_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$other_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$other_win+0?></td>
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="单式" style="color: #F37605;" href="sport_user.php?gtype=<?=urldecode('单式')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">单式</a>
                        </td>
                        <td align="center" valign="middle"><?=$ds_result["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$ds_result["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$ds_result_valid["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$ds_win+0?></td>
                        <td align="center" valign="middle"><?=$ds_result["bet_money"]-$ds_win?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle" colspan="6">单式=足球+篮球+网球+排球+棒球+其他。</td>
                    </tr>

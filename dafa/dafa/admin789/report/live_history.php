        ...
        <tr>
            <td valign="top">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
                    ...
                    $zr_result_bbin = report_live::getBetMoneyAndCount($s_time,$e_time,"BBIN","转入",$inUserString);
                    $zc_result_bbin = report_live::getBetMoneyAndCount($s_time,$e_time,"BBIN","转出",$inUserString);

                   $zr_result_MG = report_live::getBetMoneyAndCount($s_time,$e_time,"MG","转入",$inUserString);
                    $zc_result_MG = report_live::getBetMoneyAndCount($s_time,$e_time,"MG","转出",$inUserString);

                    $zr_result_NA = report_live::getBetMoneyAndCount($s_time,$e_time,"NA","转入",$inUserString);
                    $zc_result_NA = report_live::getBetMoneyAndCount($s_time,$e_time,"NA","转出",$inUserString);

                    $zr_result_PT = report_live::getBetMoneyAndCount($s_time,$e_time,"PT","转入",$inUserString);
                    $zc_result_PT = report_live::getBetMoneyAndCount($s_time,$e_time,"PT","转出",$inUserString);

                    $zr_result_ALLBEY = report_live::getBetMoneyAndCount($s_time,$e_time,"ALLBET","转入",$inUserString);
                    $zc_result_ALLBET = report_live::getBetMoneyAndCount($s_time,$e_time,"ALLBET","转出",$inUserString);
					...
					$sql2 = report_live::getZhenRenCount($s_time,$e_time,$inUserString);
                        ...
                        while($row = $query->fetch_array()){
							...
							$zr_result["bet_count"] = $row['bishu'];
							$zr_result["bet_money"] = -$row['zonge'];
							}
							if($row['about']=='AG大厅->体育/彩票账户'){
							$zc_result["bet_count"] = $row['bishu'];
							$zc_result["bet_money"] = $row['zonge'];
							}
							if($row['about']=='体育/彩票账户->BBIN大厅'){
							$zr_result_bbin["bet_count"] = $row['bishu'];
							$zr_result_bbin["bet_money"] = -$row['zonge'];
							}
							if($row['about']=='BBIN大厅->体育/彩票账户'){
							$zc_result_bbin["bet_count"] = $row['bishu'];
							$zc_result_bbin["bet_money"] = $row['zonge'];
							}
							if($row['about']=='体育/彩票账户->MG大厅'){
							$zr_result_MG["bet_count"] = $row['bishu'];
							$zr_result_MG["bet_money"] = -$row['zonge'];
							}
							if($row['about']=='MG大厅->体育/彩票账户'){
							$zc_result_MG["bet_count"] = $row['bishu'];
							$zc_result_MG["bet_money"] = $row['zonge'];
							}
							if($row['about']=='体育/彩票账户->NA大厅'){
							$zr_result_NA["bet_count"] = $row['bishu'];
							$zr_result_NA["bet_money"] = -$row['zonge'];
							}
							if($row['about']=='NA大厅->体育/彩票账户'){
							$zc_result_NA["bet_count"] = $row['bishu'];
							$zc_result_NA["bet_money"] = $row['zonge'];
							}
							if($row['about']=='体育/彩票账户->PT大厅'){
							$zr_result_PT["bet_count"] = $row['bishu'];
							$zr_result_PT["bet_money"] = -$row['zonge'];
							}
							if($row['about']=='PT大厅->体育/彩票账户'){
							$zc_result_PT["bet_count"] = $row['bishu'];
							$zc_result_PT["bet_money"] = $row['zonge'];
							}
							if($row['about']=='体育/彩票账户->ALLBET大厅'){
							$zr_result_ALLBET["bet_count"] = $row['bishu'];
							$zr_result_ALLBET["bet_money"] = -$row['zonge'];
							}
							if($row['about']=='ALLBET大厅->体育/彩票账户'){
							$zc_result_ALLBET["bet_count"] = $row['bishu'];
							$zc_result_ALLBET["bet_money"] = $row['zonge'];
							}
                        }
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="BBIN" style="color: #F37605;"  href="live_details.php?gtype=<?=urldecode('BBIN')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">BBIN</a>
                        </td>
					...
					<tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="MG" style="color: #F37605;"  href="live_details.php?gtype=<?=urldecode('MG')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">MG</a>
                        </td>
                        <td align="center" valign="middle"><?=(0+$zr_result_MG["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zr_result_MG["bet_money"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_MG["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_MG["bet_money"])?></td>
					...
					<tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="NA" style="color: #F37605;"  href="live_details.php?gtype=<?=urldecode('NA')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">NA</a>
                        </td>
                        <td align="center" valign="middle"><?=(0+$zr_result_NA["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zr_result_NA["bet_money"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_NA["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_NA["bet_money"])?></td>
                        <td align="center" valign="middle"><?=($zr_result_NA["bet_count"] + $zc_result_MG["bet_count"])?></td>
                        <td align="center" valign="middle"><?=($zr_result_NA["bet_money"] - $zc_result_MG["bet_money"])?></td>
                    </tr>
					<tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="PT" style="color: #F37605;"  href="live_details.php?gtype=<?=urldecode('PT')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">PT</a>
                        </td>
                        <td align="center" valign="middle"><?=(0+$zr_result_PT["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zr_result_PT["bet_money"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_PT["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_PT["bet_money"])?></td>
					...
					<tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="ALLBET" style="color: #F37605;"  href="live_details.php?gtype=<?=urldecode('ALLBET')?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">ALLBET</a>
                        </td>
                        <td align="center" valign="middle"><?=(0+$zr_result_ALLBET["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zr_result_ALLBET["bet_money"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_ALLBET["bet_count"])?></td>
                        <td align="center" valign="middle"><?=(0+$zc_result_ALLBET["bet_money"])?></td>
                        <td align="center" valign="middle"><?=($zr_result_ALLBET["bet_count"] + $zc_result_ALLBET["bet_count"])?></td>
                        <td align="center" valign="middle"><?=($zr_result_ALLBET["bet_money"] - $zc_result_ALLBET["bet_money"])?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">总计</td>
                        <td align="center" valign="middle"><?=($zr_result["bet_count"]+$zr_result_bbin["bet_count"]+$zr_result_MG["bet_count"])?></td>
                        <td align="center" valign="middle"><?=($zr_result["bet_money"]+$zr_result_bbin["bet_money"]+$zr_result_MG["bet_money"])?></td>
                        <td align="center" valign="middle"><?=($zc_result["bet_count"]+$zc_result_bbin["bet_count"]+$zc_result_MG["bet_count"])?></td>
                        <td align="center" valign="middle"><?=($zc_result["bet_money"]+$zc_result_bbin["bet_money"]+$zc_result_MG["bet_money"])?></td>
                        <td align="center" valign="middle"><?=($zr_result["bet_count"] + $zc_result["bet_count"] + $zr_result_bbin["bet_count"] + $zc_result_bbin["bet_count"] + $zr_result_MG["bet_count"] + $zc_result_MG["bet_count"])?></td>
                        <td align="center" valign="middle"><?=($zr_result["bet_money"] - $zc_result["bet_money"] + $zr_result_bbin["bet_money"] - $zc_result_bbin["bet_money"] + $zr_result_MG["bet_money"] - $zc_result_MG["bet_money"])?></td>
                    </tr>

...
//                            }
                            ...
                            <tr align="center" onMouseOver="this.style.backgroundColor='<?=$over?>'" onMouseOut="this.style.backgroundColor='<?=$out?>'" style="background-color:<?=$color?>; line-height:20px;">
                                <td height="40" align="center" valign="middle"><?=getZhPageTitle($_GET["gtype"])?></td>
                                <td align="center" valign="middle"><a title="<?=$rows['user_name']?>" style="color: #F37605;" href="lottery_details.php?gtype=<?=$_GET["gtype"]?>&amp;s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_id=<?=$rows['user_id']?>&amp;date_month=<?=$date_month?>&amp;user_group=<?=$rows['user_name']?>&amp;user_ignore_group=<?=$user_ignore_group?>"><?=$rows['user_name']?></a>(<?=$rows['pay_name']?>)</td>

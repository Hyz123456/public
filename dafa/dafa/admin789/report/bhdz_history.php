                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="棋牌" style="color: #F37605;"  href="bhdz_details.php?s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">棋牌</a>
                        </td>
                        <td align="center" valign="middle"><?=$bet_count70+0?></td>
                        <td align="center" valign="middle"><?=0-$bet_money70?></td>
                        <td align="center" valign="middle"><?=$bet_count71+0?></td>
                        <td align="center" valign="middle"><?=$bet_money71+0?></td>
                        <td align="center" valign="middle"><?=$bet_count70+$bet_count71?></td>
                        <td align="center" valign="middle"><?=0-$bet_money70-$bet_money71?></td>
                    </tr>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">

        ...
        <tr>
            <td valign="top">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
                    ...
                    $sql	=	"SELECT sum(o_sub.bet_money) bet_money_total,
                    ...
                    $sql.=" and o.bet_time>='".$s_time." 00:00:00'";
                    $sql.=" and o.bet_time<='".$e_time." 23:59:59'";
                    $query	=	$mysqli->query($sql);
                    $rows = $query->fetch_array();
                    $lhc_win = $rows["win_total"];

                    ?>
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        <td height="25" align="center" valign="middle">
                            <a title="六合彩" style="color: #F37605;" href="six_lottery_user.php?s_time=<?=$s_time?>&amp;e_time=<?=$e_time?>&amp;user_group=<?=$user_group?>&amp;user_ignore_group=<?=$user_ignore_group?>&amp;date_month=<?=$date_month?>">六合彩</a>
                        </td>
                        ...
                        <td align="center" valign="middle"><?=$lhc_win+0?></td>

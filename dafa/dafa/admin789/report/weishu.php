    ...
    <form name="form1" id="form1" method="get" action="<?=$_SERVER["REQUEST_URI"]?>" onSubmit="return true;">
        <tr>
            <td align="left" bgcolor="#FFFFFF">
                <span title="六合彩平特尾数报表" style="color: blue;">六合彩平特尾数报表</span>
            </td>
        </tr>
        <tr>
            <td align="left" bgcolor="#FFFFFF">
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#ccc">
    ...
    $sql1 = "SELECT o_sub.number,SUM(IF(o.rtype='SPB',o_sub.bet_money,0)) bet_money_total
            FROM six_lottery_order o, six_lottery_order_sub o_sub
            WHERE o.rtype='SPB' AND o.order_num=o_sub.order_num
                AND
                (o_sub.number='尾0' OR o_sub.number='尾1' OR o_sub.number='尾2' OR o_sub.number='尾3' OR o_sub.number='尾4' OR  o_sub.number='尾5' OR o_sub.number='尾6' OR o_sub.number='尾7' OR o_sub.number='尾8' OR o_sub.number='尾9')
                AND o.lottery_number=$qishu_query
            GROUP BY o_sub.number";
    ...
    <tr align="center" style="background-color:white; line-height:20px;">
        <td height="40" align="center" valign="middle">六合彩</td>
        <td align="center" valign="middle">平特尾数</td>
        <td align="center" valign="middle">合计</td>
        <td align="center" valign="middle"><?=$total_all+0?></td>
    </tr>

...
?>
<table width="100%" border="0" bgcolor="#FFFFFF" bordercolor="#96B697" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color: #225d9c;" id=editProduct   idth="100%" >
  <tr>
    <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">管理员管理：设置密码</span></font></td>
  </tr>
  <tr>
    <td height="24" align="center" nowrap bgcolor="#FFFFFF"><form onSubmit="return check_sub();" action="<?=$_SERVER['PHP_SELF']?>?action=save&uid=<?=$rows["id"]?>" method="post" name="form1">
      <p>&nbsp;</p>
      <table width="661" border="1" align="center" bordercolor="#333333"  style="border-collapse:collapse;color:#fff;">
  <tr>
    <td bgcolor="#5a5a5a">管理员</td>
    <td style="color:#000;"><?=$rows["manage_name"]?></td>
  </tr>
  <tr>
    <td width="172" bgcolor="#5a5a5a">密码</td>
    <td width="473"><input id="password" type="password" name="password" value=""/></td>
  </tr>
  <tr>
    <td bgcolor="#5a5a5a">确认密码</td>
    <td><input id="password2" type="password"  name="password2" value=""/></td>
  </tr>
    <tr>
    <td bgcolor="#5a5a5a">操作</td>

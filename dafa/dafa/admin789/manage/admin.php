...
<table width="90%" align="center" border="1" bgcolor="#FFFFFF" bordercolor="#ccc" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color:#999;">
  <tr>
    <td width="172" bgcolor="#eeeeee">登陆名称</td>
    <td width="473"><?=$manage_str?></td>
  </tr>
  <tr>
    <td width="172" bgcolor="#eeeeee">登陆密码</td>
    <td width="473"><input name="login_pwd" type="text" size="30"/></td>
  </tr>
  <tr>
    <td bgcolor="#eeeeee">权限设置</td>
    <td>
     <?
	 $temp_i=0;
     foreach($qx as $key => $t)

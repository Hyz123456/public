...
<br>
<?
$sql	=	"select money.*,user_list.user_name,user_list.pay_name,user_list.remark from money left join user_list on money.user_id=user_list.user_id  where money.id='".$_GET["id"]."'";
$query	=	$mysqli->query($sql);

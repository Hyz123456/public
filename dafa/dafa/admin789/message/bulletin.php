...
if($_GET["action2"]=="del"){   
    $sql_del="delete from sys_announcement2 where id='".$nid."' ";
    $query_del=$mysqli->query($sql_del);
}
//echo "<pre>";
//print_r($_GET['action3']);
foreach($_GET['action3'] as $val){
//$id=implode(",",$_GET['action3']);

	$sql_delall=" delete from sys_announcement2 where id ='".$val."' ";
	$query_delall=$mysqli->query($sql_delall);
}
?>
...
<table width="100%" align="center"  id=editProduct   idth="100%" >
    <tr>
        <td height="24" nowrap class="bg_tr"><font >&nbsp;<span class="STYLE2">公告管理：管理网站公告信息</span></font></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC"><tr><td ><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
                <tr>
                    <td height="24" nowrap bgcolor="#FFFFFF"><table width="100%" border="1" bgcolor="#FFFFFF" bordercolor="#ccc" cellspacing="0" cellpadding="0" style="border-collapse: collapse; color: #225d9c;" id=editProduct   idth="100%" >
                            <tr class="bg_tr" style="line-height: 1.5em;">
							    <td width="100" align="center"><strong onclick="qxuan()">全选/全不选</strong></td>
								...
								<td width="46" align="center"><strong>操作</strong></td>
                            </tr>
                            <?php
                            ...
                            if($nid){
                                ...
                                while($rows = $query->fetch_array()){
                                    ...
                                    <tr onMouseOver="this.style.backgroundColor='#EBEBEB'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;">
										...
										<td align="center"><input type="checkbox" name="delete"value="<?=$rows["id"]?>"></td>
										...
										<td align="center"><a href="bulletin.php?nid=<?=$rows["id"]?>&action2=del">删除</a></td>
                                    </tr>
                                <?php
                                }
                            }
				...
				<tr>
                    <td ><input type="button" onclick="delAll()" value="一键删除"></td>
                </tr>
            </table></td></tr>
</table>
</body>
